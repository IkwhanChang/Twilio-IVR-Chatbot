...
function getDoc(reference) {
    ...
    var client = ensureFirestoreConfigured(firestore);
    var deferred = new Deferred();
    firestore._queue.enqueueAndForget(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
        var eventManager;
        return tslib.__generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, readDocumentViaSnapshotListener(eventManager, firestore._queue, reference._key, { source: 'default' }, deferred)];
                case 2:
                    _d.sent();
                    return [2 /*return*/];
            }
    ...
    return deferred.promise.then(function (snapshot) { return convertToDocSnapshot(firestore, reference, snapshot); });
}
...
function getDocFromCache(reference) {
    ...
    firestore._queue.enqueueAndForget(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    localStore = _d.sent();
                    return [4 /*yield*/, readDocumentFromCache(localStore, reference._key, deferred)];
                case 2:
                    _d.sent();
                    return [2 /*return*/];
            }
    ...
    return deferred.promise.then(function (doc) { return new DocumentSnapshot$1(firestore, userDataWriter, reference._key, doc, new SnapshotMetadata(doc instanceof Document ? doc.hasLocalMutations : false, 
    ...
    firestore._queue.enqueueAndForget(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    eventManager = _d.sent();
                    return [4 /*yield*/, readDocumentViaSnapshotListener(eventManager, firestore._queue, reference._key, { source: 'server' }, deferred)];
                case 2:
                    _d.sent();
                    return [2 /*return*/];
            }
...
function getDocs(query) {
    ...
    firestore._queue.enqueueAndForget(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    eventManager = _d.sent();
                    return [4 /*yield*/, executeQueryViaSnapshotListener(eventManager, firestore._queue, query._query, { source: 'default' }, deferred)];
                case 2:
                    _d.sent();
                    return [2 /*return*/];
            }
    ...
    return deferred.promise.then(function (snapshot) { return new QuerySnapshot(firestore, userDataWriter, query, snapshot); });
}
/**
    ...
    firestore._queue.enqueueAndForget(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    localStore = _d.sent();
                    return [4 /*yield*/, executeQueryFromCache(localStore, query._query, deferred)];
                case 2:
                    _d.sent();
                    return [2 /*return*/];
            }
    ...
    firestore._queue.enqueueAndForget(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    eventManager = _d.sent();
                    return [4 /*yield*/, executeQueryViaSnapshotListener(eventManager, firestore._queue, query._query, { source: 'server' }, deferred)];
                case 2:
                    _d.sent();
                    return [2 /*return*/];
            }
...
function onSnapshot(reference) {
    ...
    if (reference instanceof DocumentReference) {
        ...
        observer = {
            next: function (snapshot) {
                if (args[currArg]) {
                    args[currArg](new QuerySnapshot(firestore, userDataWriter_1, reference, snapshot));
                }
            },
            error: args[currArg + 1],
            complete: args[currArg + 2]
    ...
    var listener = new QueryListener(internalQuery, wrappedObserver, internalOptions);
    firestore._queue.enqueueAndForget(function () { return tslib.__awaiter(_this, void 0, void 0, function () {
        var eventManager;
        return tslib.__generator(this, function (_d) {
            switch (_d.label) {
...
var Query$1 = /** @class */ (function (_super) {
    ...
    Query$1.prototype.get = function (options) {
        ...
        return query.then(function (result) { return new QuerySnapshot$1(_this.firestore, result); });
    };
    Query$1.prototype.onSnapshot = function () {
        ...
        var options = extractSnapshotOptions(args);
        var observer = wrapObserver(args, function (snap) { return new QuerySnapshot$1(_this.firestore, snap); });
        return onSnapshot(this._delegate, options, observer);
    };
