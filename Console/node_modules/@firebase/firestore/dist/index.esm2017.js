...
/** A dot-separated path for navigating sub-objects within a document. */ class z extends W {
    ...
    J() {
        return this.H().map((t => (t = t.replace("\\", "\\\\").replace("`", "\\`"), z.Z(t) || (t = "`" + t + "`"), 
        t))).join(".");
    }
    toString() {
        return this.J();
    ...
    hr(t) {
        ...
        y("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.ar = this.di.Us("lru_garbage_collection" /* LruGarbageCollection */ , e, (async () => {
            ...
            try {
                ...
                Ss(t) ? y("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await Tr(t);
            }
            await this.hr(t);
        }));
    }
...
function js(t) {
    let e = "";
    for (let n = 0; n < t.length; n++) e.length > 0 && (e = zs(e)), e = Gs(t.get(n), e);
    return zs(e);
}

/** Encodes a single segment of a resource path into the given result */ function Gs(t, e) {
    let n = e;
    const s = t.length;
    for (let e = 0; e < s; e++) {
        const s = t.charAt(e);
...
/** Decodes a remote document from storage locally to a Document. */ function Ys(t, e) {
    ...
    if (e.noDocument) {
        const t = H.ct(e.noDocument.path), n = ni(e.noDocument.readTime);
        return new Cn(t, n, {
            hasCommittedMutations: !!e.hasCommittedMutations
        });
    }
    if (e.unknownDocument) {
        const t = H.ct(e.unknownDocument.path), n = ni(e.unknownDocument.version);
        return new Nn(t, n);
    }
    return b();
}
...
/** Encodes a document for storage locally. */ function Xs(t, e, n) {
    ...
    if (e instanceof Cn) {
        const t = e.key.path.H(), n = ei(e.version), r = e.hasCommittedMutations;
        return new Si(
        /* unknownDocument= */ null, new vi(t, n), 
        /* document= */ null, r, s, i);
    }
    if (e instanceof Nn) {
        const t = e.key.path.H(), n = ei(e.version);
        return new Si(new bi(t, n), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
function ei(t) {
    const e = t.M();
    return new Pi(e.seconds, e.nanoseconds);
}
...
function si(t, e) {
    const n = (e.baseMutations || []).map((e => De(t.yr, e))), s = e.mutations.map((e => De(t.yr, e))), i = Q.fromMillis(e.localWriteTimeMs);
    return new _s(e.batchId, i, n, s);
}

/** Decodes a DbTarget into TargetData */ function ii(t) {
    const e = ni(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? ni(t.lastLimboFreeSnapshotVersion) : K.min();
    let s;
    var i;
...
/** Encodes TargetData into a DbTarget for storage locally. */ function ri(t, e) {
    const n = ei(e.ft), s = ei(e.lastLimboFreeSnapshotVersion);
    let i;
    i = it(e.target) ? Ne(t.yr, e.target) : xe(t.yr, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
        const r = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new Ci(e.targetId, et(e.target), n, r, e.sequenceNumber, s, i);
}
...
class ci {
     ...
     */
    t, e, n, s) {
        this.userId = t, this.serializer = e, this.os = n, this.Vr = s, 
        /**
    ...
    Sr(t, e, n, s) {
        ...
        return r.add({}).next((o => {
            ...
            const c = new _s(o, e, n, s), u = function(t, e, n) {
                const s = n.baseMutations.map((e => Se(t.yr, e))), i = n.mutations.map((e => Se(t.yr, e)));
                return new Vi(e, n.batchId, n.gn.toMillis(), s, i);
            }(this.serializer, this.userId, c), a = [];
            let h = new wt(((t, e) => B(t.J(), e.J())));
            for (const t of s) {
                const e = pi.key(this.userId, t.key.path, o);
                h = h.add(t.key.path.q()), a.push(r.put(u)), a.push(i.put(e, pi.PLACEHOLDER));
            }
            return h.forEach((e => {
                a.push(this.os.Dr(t, e));
            })), t.es((() => {
                this.pr[o] = c.keys();
            })), ws.qn(a).next((() => c));
        }));
    ...
    Cr(t, e) {
        return hi(t).get(e).next((t => t ? (S(t.userId === this.userId), si(this.serializer, t)) : null));
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    Nr(t, e) {
        return this.pr[e] ? ws.resolve(this.pr[e]) : this.Cr(t, e).next((t => {
            if (t) {
                const n = t.keys();
    ...
    Fr(t, e) {
        ...
        return hi(t)._i({
            ...
            e.userId === this.userId && (S(e.batchId >= n), i = si(this.serializer, e)), s.done();
        })).next((() => i));
    }
    Or(t) {
    ...
    Mr(t) {
        ...
        return hi(t).ui(Vi.userMutationsIndex, e).next((t => t.map((t => si(this.serializer, t)))));
    }
    us(t, e) {
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
        const n = pi.prefixForPath(this.userId, e.path), s = IDBKeyRange.lowerBound(n), i = [];
        return li(t)._i({
            range: s
        }, ((n, s, r) => {
            const [o, c, u] = n, a = Hs(c);
            ...
            return hi(t).get(u).next((t => {
                if (!t) throw b();
                S(t.userId === this.userId), i.push(si(this.serializer, t));
            }));
            r.done();
        })).next((() => i));
    }
    ds(t, e) {
        ...
        const s = [];
        return e.forEach((e => {
            const i = pi.prefixForPath(this.userId, e.path), r = IDBKeyRange.lowerBound(i), o = li(t)._i({
                range: r
            }, ((t, s, i) => {
                const [r, o, c] = t, u = Hs(o);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
            ...
            s.push(o);
        })), ws.qn(s).next((() => this.kr(t, n)));
    }
    Rs(t, e) {
        const n = e.path, s = n.length + 1, i = pi.prefixForPath(this.userId, n), r = IDBKeyRange.lowerBound(i);
    ...
    kr(t, e) {
        ...
        return e.forEach((e => {
            s.push(hi(t).get(e).next((t => {
                if (null === t) throw b();
                S(t.userId === this.userId), n.push(si(this.serializer, t));
            })));
        })), ws.qn(s).next((() => n));
    }
    $r(t, e) {
        return ai(t.Lr, this.userId, e).next((n => (t.es((() => {
            this.Br(e.batchId);
        })), ws.forEach(n, (e => this.Vr.qr(t, e))))));
    }
    /**
    ...
    Ur(t) {
        return this.br(t).next((e => {
            if (!e) return ws.resolve();
            // Verify that there are no entries in the documentMutations index if
            // the queue is empty.
                        const n = IDBKeyRange.lowerBound(pi.prefixForUser(this.userId)), s = [];
            return li(t)._i({
                range: n
            }, ((t, e, n) => {
                if (t[0] === this.userId) {
    ...
    Kr(t) {
        return _i(t).get(this.userId).next((t => t || new yi(this.userId, -1, 
        /*lastStreamToken=*/ "")));
    }
}
 ...
 */ function ui(t, e, n) {
    const s = pi.prefixForPath(e, n.path), i = s[1], r = IDBKeyRange.lowerBound(s);
    let o = !1;
    return li(t)._i({
        range: r,
        li: !0
 ...
 */
function ai(t, e, n) {
    const s = t.store(Vi.store), i = t.store(pi.store), r = [], o = IDBKeyRange.only(n.batchId);
    let c = 0;
    const u = s._i({
        range: o
    }, ((t, e, n) => (c++, n.delete())));
    ...
    for (const t of n.mutations) {
        const s = pi.key(e, t.key.path, n.batchId);
 ...
 */ function hi(t) {
    return Xi.Ys(t, Vi.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function li(t) {
    return Xi.Ys(t, pi.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function _i(t) {
    return Xi.Ys(t, yi.store);
}
 ...
 */ class fi {
    ...
    Jn(t, e) {
        return Ei(t).get(Ti(e)).next((t => this.jr(t)));
    }
    /**
     ...
     */    Hr(t, e) {
        ...
        return this.zr(t, e, ((t, e) => {
            const i = this.jr(e);
            i ? (n = n.Tt(t, i), s = s.Tt(t, Ii(e))) : (n = n.Tt(t, null), s = s.Tt(t, 0));
        })).next((() => ({
            Jr: n,
            Yr: s
        })));
    ...
    ws(t, e, n) {
        ...
        if (n.isEqual(K.min())) {
            ...
            const t = e.path.H(), s = Zs(n);
            r.range = IDBKeyRange.lowerBound([ t, s ], 
            /* open= */ !0), r.index = Si.collectionReadTimeIndex;
        }
        return Ei(t)._i(r, ((t, n, r) => {
            ...
            const o = Ys(this.serializer, n);
            e.path.j(o.key.path) ? o instanceof Dn && Gn(e, o) && (s = s.Tt(o.key, o)) : r.done();
        })).next((() => s));
    }
    Xr(t) {
        return new di(this, !!t && t.Zr);
    }
    eo(t) {
        return this.getMetadata(t).next((t => t.byteSize));
    }
    getMetadata(t) {
        return wi(t).get(Di.key).next((t => (S(!!t), t)));
    }
    Wr(t, e) {
        return wi(t).put(Di.key, e);
    }
    /**
...
class di extends Es {
     ...
     */
    constructor(t, e) {
        super(), this.no = t, this.Zr = e, 
        // A map of document sizes prior to applying the changes in this buffer.
        this.so = new ds((t => t.toString()), ((t, e) => t.isEqual(e)));
    }
    Zn(t) {
        const e = [];
        let n = 0, s = new wt(((t, e) => B(t.J(), e.J())));
        return this.Qn.forEach(((i, r) => {
            const o = this.so.get(i);
            if (r.zn) {
                const c = Xs(this.no.serializer, r.zn, this.Wn(i));
                s = s.add(i.path.q());
                const u = Ii(c);
                n += u - o, e.push(this.no.jn(t, i, c));
            } else if (n -= o, this.Zr) {
                // In order to track removals, we store a "sentinel delete" in the
                // RemoteDocumentCache. This entry is represented by a NoDocument
                // with a version of 0 and ignored by `maybeDecodeDocument()` but
                // preserved in `getNewDocumentChanges()`.
                const n = Xs(this.no.serializer, new Cn(i, K.min()), this.Wn(i));
                e.push(this.no.jn(t, i, n));
            } else e.push(this.no.Hn(t, i));
        })), s.forEach((n => {
            e.push(this.no.os.Dr(t, n));
        })), e.push(this.no.updateMetadata(t, n)), ws.qn(e);
    }
    Yn(t, e) {
        // Record the size of everything we load from the cache so we can compute a delta later.
        return this.no.Gr(t, e).next((t => null === t ? (this.so.set(e, 0), null) : (this.so.set(e, t.size), 
        t.zn)));
    }
    Xn(t, e) {
        // Record the size of everything we load from the cache so we can compute
        // a delta later.
        return this.no.Hr(t, e).next((({Jr: t, Yr: e}) => (
...
function wi(t) {
    return Xi.Ys(t, Di.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function Ei(t) {
    return Xi.Ys(t, Si.store);
}
 ...
 */ class mi {
    ...
    Dr(t, e) {
        return this.io.add(e), ws.resolve();
    }
    As(t, e) {
        return ws.resolve(this.io.getEntries(e));
    }
}
 ...
 */ (t));
        ...
        0 !== n && (!function(t) {
            t.deleteObjectStore(Ni.store), t.deleteObjectStore(Ci.store), t.deleteObjectStore(xi.store);
        }(t), Oi(t)), r = r.next((() => 
        /**
 ...
 */
        function(t) {
            const e = t.store(xi.store), n = new xi(
            /*highestTargetId=*/ 0, 
 ...
 */ (i)))), n < 4 && s >= 4 && (0 !== n && (
        ...
        r = r.next((() => function(t, e) {
            return e.store(Vi.store).ui().next((n => {
                t.deleteObjectStore(Vi.store);
                t.createObjectStore(Vi.store, {
                    keyPath: Vi.keyPath,
                    autoIncrement: !0
                }).createIndex(Vi.userMutationsIndex, Vi.userMutationsKeyPath, {
                ...
                const s = e.store(Vi.store), i = n.map((t => s.put(t)));
                return ws.qn(i);
            }));
        }
        /**
 ...
 */ (t), this.addDocumentGlobal(i))))), n < 7 && s >= 7 && (r = r.next((() => this.ensureSequenceNumbers(i)))), 
        ...
        n < 9 && s >= 9 && (r = r.next((() => {
            ...
            !function(t) {
                ...
                const e = t.objectStore(Si.store);
 ...
 */ (t), function(t) {
    ...
    addDocumentGlobal(t) {
        let e = 0;
        return t.store(Si.store)._i(((t, n) => {
            e += Ii(n);
        })).next((() => {
            const n = new Di(e);
    ...
    removeAcknowledgedMutations(t) {
        const e = t.store(yi.store), n = t.store(Vi.store);
        return e.ui().next((e => ws.forEach(e, (e => {
            const s = IDBKeyRange.bound([ e.userId, -1 ], [ e.userId, e.lastAcknowledgedBatchId ]);
            return n.ui(Vi.userMutationsIndex, s).next((n => ws.forEach(n, (n => {
                S(n.userId === e.userId);
                const s = si(this.serializer, n);
     ...
     */    ensureSequenceNumbers(t) {
        ...
        return t.store(xi.store).get(xi.key).next((t => {
            const s = [];
            return n._i(((n, i) => {
 ...
 */ (r);
                s.push(e.get(o).next((n => n ? ws.resolve() : (n => e.put(new Ni(0, js(n), t.highestListenSequenceNumber)))(r))));
            })).next((() => ws.qn(s)));
        }));
    }
    createCollectionParentIndex(t, e) {
        ...
        const n = e.store(Fi.store), s = new Ai, i = t => {
            if (s.add(t)) {
                const e = t.K(), s = t.q();
                return n.put({
                    collectionId: e,
        ...
        return e.store(Si.store)._i({
            li: !0
        }, ((t, e) => {
            const n = new j(t);
            return i(n.q());
        })).next((() => e.store(pi.store)._i({
            li: !0
        }, (([t, e, n], s) => {
            const r = Hs(e);
            return i(r.q());
    ...
    rewriteCanonicalIds(t) {
        const e = t.store(Ci.store);
        return e._i(((t, n) => {
            const s = ii(n), i = ri(this.serializer, s);
            return e.put(i);
        }));
    }
}
...
/** Name of the IndexedDb object store.  */ yi.store = "mutationQueues", 
...
Ci.queryTargetsIndexName = "queryTargetsIndex", 
/**
 * The index of all canonicalIds to the targets that they match. This is not
 * a unique mapping because canonicalId does not promise a unique name for all
 * possible queries, so we append the targetId to make the mapping unique.
 */
Ci.queryTargetsKeyPath = [ "canonicalId", "targetId" ];
...
/** Name of the IndexedDb object store.  */ Ni.store = "targetDocuments", 
/** Keys are automatically assigned via the targetId, path properties. */
Ni.keyPath = [ "targetId", "path" ], 
/** The index name for the reverse index. */
Ni.documentTargetsIndex = "documentTargetsIndex", 
/** We also need to create the reverse index for these properties. */
Ni.documentTargetsKeyPath = [ "path", "targetId" ];
...
/** Name of the IndexedDb object store. */ function Oi(t) {
    t.createObjectStore(Ni.store, {
        keyPath: Ni.keyPath
    }).createIndex(Ni.documentTargetsIndex, Ni.documentTargetsKeyPath, {
        unique: !0
    });
    // NOTE: This is unique only because the TargetId is the suffix.
    t.createObjectStore(Ci.store, {
        keyPath: Ci.keyPath
    }).createIndex(Ci.queryTargetsIndexName, Ci.queryTargetsKeyPath, {
        unique: !0
...
/** Name of the IndexedDb object store. */ ki.store = "bundles", ki.keyPath = "bundleId";
...
/** Name of the IndexedDb object store. */ $i.store = "namedQueries", $i.keyPath = "name";

const Li = [ ...[ ...[ ...[ ...[ yi.store, Vi.store, pi.store, Si.store, Ci.store, gi.store, xi.store, Ni.store ], Mi.store ], Di.store ], Fi.store ], ki.store, $i.store ];
...
class Bi {
    ...
    uo(t, e) {
        return Ui(t).put(function(t) {
            return {
                name: t.name,
                readTime: ei(Te(t.readTime)),
 ...
 */ function qi(t) {
    return Xi.Ys(t, ki.store);
}

/**
 * Helper to get a typed SimpleDbStore for the namedQueries object store.
 */ function Ui(t) {
    return Xi.Ys(t, $i.store);
}
 ...
 */ class ji {
    ...
    To(t) {
        return this.wo(t).next((t => K.N(new Q(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds))));
    }
    Io(t) {
        return this.wo(t).next((t => t.highestListenSequenceNumber));
    }
    mo(t, e, n) {
        return this.wo(t).next((s => (s.highestListenSequenceNumber = e, n && (s.lastRemoteSnapshotVersion = n.M()), 
    ...
    Vo(t, e) {
        return this.po(t, e.targetId).next((() => Gi(t).delete(e.targetId))).next((() => this.wo(t))).next((e => (S(e.targetCount > 0), 
     ...
     */    mr(t, e, n) {
        ...
        return Gi(t)._i(((r, o) => {
            const c = ii(o);
            c.sequenceNumber <= e && null === n.get(c.targetId) && (s++, i.push(this.Vo(t, c)));
        })).next((() => ws.qn(i))).next((() => s));
    }
    /**
    ...
    wo(t) {
        return zi(t).get(xi.key).next((t => (S(null !== t), t)));
    }
    Eo(t, e) {
        return zi(t).put(xi.key, e);
    }
    Ro(t, e) {
        return Gi(t).put(ri(this.serializer, e));
    }
    /**
    ...
    bo(t, e) {
        ...
        return Gi(t)._i({
            range: s,
            index: Ci.queryTargetsIndexName
        }, ((t, n, s) => {
            const r = ii(n);
    ...
    So(t, e, n) {
        ...
        return e.forEach((e => {
            const r = js(e.path);
            s.push(i.put(new Ni(n, r))), s.push(this.Vr.Do(t, n, e));
        })), ws.qn(s);
    }
    Co(t, e, n) {
        // PORTING NOTE: The reverse index (documentsTargets) is maintained by
        ...
        return ws.forEach(e, (e => {
            const i = js(e.path);
            return ws.qn([ s.delete([ n, i ]), this.Vr.No(t, n, e) ]);
        }));
    }
    po(t, e) {
        const n = Hi(t), s = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(s);
    }
    xo(t, e) {
        ...
        return s._i({
            ...
            const s = Hs(t[1]), r = new H(s);
            i = i.add(r);
        })).next((() => i));
    }
    Qr(t, e) {
        const n = js(e.path), s = IDBKeyRange.bound([ n ], [ U(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        let i = 0;
        return Hi(t)._i({
            index: Ni.documentTargetsIndex,
            li: !0,
            range: s
        }, (([t, e], n, s) => {
    ...
    // PORTING NOTE: Multi-tab only.
    Ze(t, e) {
        return Gi(t).get(e).next((t => t ? ii(t) : null));
    }
}
 ...
 */ function Gi(t) {
    return Xi.Ys(t, Ci.store);
}

/**
 * Helper to get a typed SimpleDbStore for the target globals object store.
 */ function zi(t) {
    return Xi.Ys(t, xi.store);
}

/**
 * Helper to get a typed SimpleDbStore for the document target object store.
 */ function Hi(t) {
    return Xi.Ys(t, Ni.store);
}
 ...
 */ class Xi {
    ...
    a) {
        ...
        this.Cs = i, this.window = r, this.document = o, this.Oo = u, this.Mo = a, this.ko = null, 
        ...
        this.Qo = t => Promise.resolve(), !Xi.Gs()) throw new N(C.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.Vr = new er(this, s), this.Ko = e + "main", this.serializer = new Js(c), this.Wo = new ps(this.Ko, 11, new Ri(this.serializer)), 
        this.jo = new ji(this.Vr, this.serializer), this.os = new Qi, this.ss = function(t, e) {
            return new fi(t, e);
        }
        /**
 ...
 */
        ...
        (this.serializer, this.os), this.Go = new Bi(this.serializer), this.window && this.window.localStorage ? this.zo = this.window.localStorage : (this.zo = null, 
    ...
    static Ys(t, e) {
        if (t instanceof Yi) return ps.Ys(t.Lr, e);
        throw b();
    }
    /**
     ...
     */    start() {
        ...
        return this.Ho().then((() => {
            ...
            return this.Jo(), this.Yo(), this.Xo(), this.runTransaction("getHighestListenSequenceNumber", "readonly", (t => this.jo.Io(t)));
        })).then((t => {
            this.ko = new ys(t, this.Oo);
        })).then((() => {
            this.$o = !0;
     ...
     * primary lease.
     */    Ho() {
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (t => tr(t).put(new Mi(this.clientId, Date.now(), this.networkEnabled, this.inForeground)).next((() => {
            if (this.isPrimary) return this.nc(t).next((t => {
                t || (this.isPrimary = !1, this.Cs.Mi((() => this.Qo(!1))));
            }));
        })).next((() => this.sc(t))).next((e => this.isPrimary && !e ? this.ic(t).next((() => !1)) : !!e && this.rc(t).next((() => !0)))))).catch((t => {
            if (Ss(t)) 
            ...
            this.isPrimary !== t && this.Cs.Mi((() => this.Qo(t))), this.isPrimary = t;
        }));
    }
    nc(t) {
        return Zi(t).get(gi.key).next((t => ws.resolve(this.oc(t))));
    }
    cc(t) {
     ...
     */    async uc() {
        if (this.isPrimary && !this.ac(this.Uo, 18e5)) {
            ...
            const t = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (t => {
                const e = Xi.Ys(t, Mi.store);
                return e.ui().next((t => {
                    const n = this.hc(t, 18e5), s = t.filter((t => -1 === n.indexOf(t)));
            ...
            // entries first to avoid potentially reviving a zombied client.
                        if (this.zo) for (const e of t) this.zo.removeItem(this.lc(e.clientId));
        }
    }
    /**
     ...
     */    Xo() {
        this.qo = this.Cs.Us("client_metadata_refresh" /* ClientMetadataRefresh */ , 4e3, (() => this.Ho().then((() => this.uc())).then((() => this.Xo()))));
    }
    /** Checks whether `client` is the local client. */    oc(t) {
     ...
     */    sc(t) {
        if (this.Mo) return ws.resolve(!0);
        return Zi(t).get(gi.key).next((e => {
            ...
            if (null !== e && this.ac(e.leaseTimestampMs, 5e3) && !this._c(e.ownerId)) {
                if (this.oc(e) && this.networkEnabled) return !0;
                if (!this.oc(e)) {
            ...
            return !(!this.networkEnabled || !this.inForeground) || tr(t).ui().next((t => void 0 === this.hc(t, 5e3).find((t => {
    ...
    async fc() {
        ...
        this.$o = !1, this.dc(), this.qo && (this.qo.cancel(), this.qo = null), this.wc(), 
        this.Ec(), 
        // Use `SimpleDb.runTransaction` directly to avoid failing if another tab
        // has obtained the primary lease.
        await this.Wo.runTransaction("shutdown", "readwrite", [ gi.store, Mi.store ], (t => {
            const e = new Yi(t, ys.Ds);
            return this.ic(e).next((() => this.cc(e)));
        })), this.Wo.close(), 
     ...
     * provided threshold.
     */    hc(t, e) {
        return t.filter((t => this.ac(t.updateTimeMs, e) && !this._c(t.clientId)));
    }
    /**
     ...
     * PORTING NOTE: This is only used for Web multi-tab.
     */    Ic() {
        return this.runTransaction("getActiveClients", "readonly", (t => tr(t).ui().next((t => this.hc(t, 18e5).map((t => t.clientId))))));
    }
    get lr() {
        return this.$o;
    }
    mc(t) {
        return ci.vr(t, this.serializer, this.os, this.Vr);
    }
    Ac() {
        return this.jo;
    }
    ...
    runTransaction(t, e, n) {
        ...
        // are the only reader/writer.
                return this.Wo.runTransaction(t, s, Li, (s => (i = new Yi(s, this.ko ? this.ko.next() : ys.Ds), 
        "readwrite-primary" === e ? this.nc(i).next((t => !!t || this.sc(i))).next((e => {
            if (!e) throw V(`Failed to obtain primary lease for action '${t}'.`), this.isPrimary = !1, 
            this.Cs.Mi((() => this.Qo(!1))), new N(C.FAILED_PRECONDITION, As);
            return n(i);
        })).next((t => this.rc(i).next((() => t)))) : this.yc(i).next((() => n(i)))))).then((t => (i.ns(), 
        t)));
    }
    /**
    ...
    // be turned off.
    yc(t) {
        return Zi(t).get(gi.key).next((t => {
            if (null !== t && this.ac(t.leaseTimestampMs, 5e3) && !this._c(t.ownerId) && !this.oc(t) && !(this.Mo || this.allowTabSynchronization && t.allowTabSynchronization)) throw new N(C.FAILED_PRECONDITION, Ji);
        }));
    }
    /**
     ...
     */    rc(t) {
        const e = new gi(this.clientId, this.allowTabSynchronization, Date.now());
        return Zi(t).put(gi.key, e);
    }
    static Gs() {
        return ps.Gs();
    }
    /** Checks the primary lease and removes it if we are the current primary. */    ic(t) {
        const e = Zi(t);
        return e.get(gi.key).next((t => this.oc(t) ? (y("IndexedDbPersistence", "Releasing primary lease."), 
        e.delete(gi.key)) : ws.resolve()));
    }
     ...
     */    _c(t) {
        var e;
        try {
            const n = null !== (null === (e = this.zo) || void 0 === e ? void 0 : e.getItem(this.lc(t)));
    ...
    /** Removes the zombied client entry if it exists. */    Tc() {
        if (this.zo) try {
 ...
 */ function Zi(t) {
    return Xi.Ys(t, gi.store);
}

/**
 * Helper to get a typed SimpleDbStore for the client metadata object store.
 */ function tr(t) {
    return Xi.Ys(t, Mi.store);
}

/** Provides LRU functionality for IndexedDB persistence. */ class er {
    constructor(t, e) {
        this.db = t, this.cr = new Ws(this, e);
    }
    Er(t) {
        const e = this.Vc(t);
        return this.db.Ac().vo(t).next((t => e.next((e => t + e))));
    }
    Vc(t) {
        let e = 0;
        return this.Ir(t, (t => {
     ...
     */    bc(t, e) {
        return function(t, e) {
            let n = !1;
            return _i(t).fi((s => ui(t, s, e).next((t => (t && (n = !0), ws.resolve(!t)))))).next((() => n));
        }(t, e);
    }
    Ar(t, e) {
        const n = this.db.Rc().Xr(), s = [];
        let i = 0;
        return this.vc(t, ((r, o) => {
            if (o <= e) {
                const e = this.bc(t, r).next((e => {
                    if (!e) 
                    // Our size accounting requires us to read all documents before
                    // removing them.
                    return i++, n.Jn(t, r).next((() => (n.Hn(r), Hi(t).delete([ 0, js(r.path) ]))));
                }));
                s.push(e);
            }
...
class ir {
    ...
    t, e, n, s) {
        this.persistence = t, this.Dc = e, this.serializer = s, 
        /**
        ...
        this.Nc = new ds((t => et(t)), st), 
        /**
         * The read time of the last entry processed by `getNewDocumentChanges()`.
         *
         * PORTING NOTE: This is only used for multi-tab synchronization.
         */
        this.xc = K.min(), this.rs = t.mc(n), this.Fc = t.Rc(), this.jo = t.Ac(), this.Oc = new Ps(this.Fc, this.rs, this.persistence.Pc()), 
        this.Go = t.gc(), this.Dc.Mc(this.Oc);
    }
    _r(t) {
        return this.persistence.runTransaction("Collect garbage", "readwrite-primary", (e => t.Rr(e, this.Cc)));
    }
}
...
async function or(t, e) {
    ...
    const r = await n.persistence.runTransaction("Handle user change", "readonly", (t => {
        ...
        // before and after.
        let r;
        return n.rs.Mr(t).next((o => (r = o, s = n.persistence.mc(e), 
        // Recreate our LocalDocumentsView using the new
        // MutationQueue.
        i = new Ps(n.Fc, s, n.persistence.Pc()), s.Mr(t)))).next((e => {
            const n = [], s = [];
    ...
    return n.rs = s, n.Oc = i, n.Dc.Mc(n.Oc), r;
}
...
function cr(t, e) {
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (t => {
        const s = e.batch.keys(), i = n.Fc.Xr({
            Zr: !0
        });
        ...
        // PORTING NOTE: Multi-Tab only.
        (n, t, e, i).next((() => i.apply(t))).next((() => n.rs.Ur(t))).next((() => n.Oc._s(t, s)));
    }));
}
    ...
    return n.persistence.runTransaction("Apply remote event", "readwrite-primary", (t => {
        ...
        e.re.forEach(((e, r) => {
            ...
            // the updated assignment.
                        o.push(n.jo.Co(t, e.de, r).next((() => n.jo.So(t, e._e, r))));
            const u = e.resumeToken;
            // Update the resume token if the change includes one.
                        if (u.ht() > 0) {
                const a = c.wt(u, s).dt(t.Fo);
                i = i.Tt(r, a), 
 ...
 */ (c, a, e) && o.push(n.jo.yo(t, a));
        ...
        // limbo.
        if (e.ce.forEach(((s, i) => {
            e.ue.has(s) && o.push(n.persistence.Vr.Sc(t, s));
        })), 
 ...
 */
        ...
        i) {
            ...
            const e = n.jo.To(t).next((e => n.jo.mo(t, t.Fo, s)));
            o.push(e);
        }
        return ws.qn(o).next((() => r.apply(t))).next((() => n.Oc.fs(t, c)));
    })).then((t => (n.Cc = i, t)));
}
...
function lr(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (t => {
        let s;
        return n.jo.bo(t, e).next((i => i ? (
        // This target has been listened to previously, so reuse the
        // previous targetID.
        // TODO(mcg): freshen last accessed date?
        s = i, ws.resolve(s)) : n.jo.fo(t).next((i => (s = new ot(e, i, 0 /* Listen */ , t.Fo), 
        n.jo.Ao(t, s).next((() => s)))))));
    })).then((t => {
        // If Multi-Tab is enabled, the existing target data may be newer than
        // the in-memory data
        const s = n.Cc.get(t.targetId);
        return (null === s || t.ft.F(s.ft) > 0) && (n.Cc = n.Cc.Tt(t.targetId, t), n.Nc.set(e, t.targetId)), 
        t;
    }));
}
...
async function _r(t, e, n) {
    const s = D(t), i = s.Cc.get(e), r = n ? "readwrite" : "readwrite-primary";
    try {
        n || await s.persistence.runTransaction("Release target", r, (t => s.persistence.Vr.removeTarget(t, i)));
    } catch (t) {
        if (!Ss(t)) throw t;
    ...
    s.Cc = s.Cc.remove(e), s.Nc.delete(i.target);
}
 ...
 */ function fr(t, e, n) {
    ...
    return s.persistence.runTransaction("Execute query", "readonly", (t => function(t, e, n) {
        const s = D(t), i = s.Nc.get(n);
        return void 0 !== i ? ws.resolve(s.Cc.get(i)) : s.jo.bo(e, n);
    }(s, t, Un(e)).next((e => {
        if (e) return i = e.lastLimboFreeSnapshotVersion, s.jo.xo(t, e.targetId).next((t => {
            r = t;
        }));
    })).next((() => s.Dc.ws(t, e, n ? i : K.min(), n ? r : yt()))).next((t => ({
        documents: t,
        Bc: r
    })))));
}
...
// PORTING NOTE: Multi-Tab only.
function dr(t, e) {
    const n = D(t), s = D(n.jo), i = n.Cc.get(e);
...
function wr(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (t => function(t, e, n) {
        const s = D(t);
        let i = It(), r = Zs(n);
        const o = Ei(e), c = IDBKeyRange.lowerBound(r, !0);
        return o._i({
 ...
 */
    // PORTING NOTE: This is only used for multi-tab synchronization.
    (e.Fc, t, e.xc))).then((({qc: t, readTime: n}) => (e.xc = n, t)));
}
...
class Ir {
    constructor(t, e, n, s, i, r) {
        this.Cs = t, this.Uc = n, this.Qc = s, this.Kc = i, this.listener = r, this.state = 0 /* Initial */ , 
        /**
         * A close count that's incremented every time the stream is closed; used by
         * getCloseGuardedDispatcher() to invalidate callbacks that happen after
         * close.
         */
        this.Wc = 0, this.jc = null, this.stream = null, this.Si = new Vs(t, e);
    }
    /**
     ...
     */    async stop() {
        this.Gc() && await this.close(0 /* Initial */);
    }
    /**
     ...
     */    Yc() {
        ...
        this.zc() && null === this.jc && (this.jc = this.Cs.Us(this.Uc, 6e4, (() => this.Xc())));
    }
    /** Sends a message to the underlying stream. */    Zc(t) {
        this.tu(), this.stream.send(t);
    }
    /** Called by the idle timer when the stream should close due to inactivity. */    async Xc() {
        if (this.zc()) 
        // When timing out an idle stream there's no reason to force the stream into backoff when
        // it restarts so set the stream state to Initial instead of Error.
        return this.close(0 /* Initial */);
    }
    /** Marks the stream as active again. */    tu() {
    ...
    auth() {
        ...
        const t = this.su(this.Wc), e = this.Wc;
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
                this.Kc.getToken().then((t => {
    ...
    iu(t) {
        const e = this.su(this.Wc);
        this.stream = this.ou(t), this.stream.cu((() => {
            e((() => (this.state = 2 /* Open */ , this.listener.cu())));
        })), this.stream.nu((t => {
            e((() => this.ru(t)));
     ...
     */    su(t) {
        return e => {
            this.Cs.Ri((() => this.Wc === t ? e() : (y("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve())));
        };
    }
}
 ...
 */ class mr extends Ir {
     ...
     */    lu(t) {
        const e = {};
        e.database = ye(this.serializer), e.removeTarget = t, this.Zc(e);
    }
}
 ...
 */ class Ar extends Ir {
    ...
    start() {
        this._u = !1, this.lastStreamToken = void 0, super.start();
    }
    eu() {
        this._u && this.du([]);
    }
    ...
    onMessage(t) {
        ...
        S(!!t.streamToken), this.lastStreamToken = t.streamToken, this._u) {
        ...
        return S(!t.writeResults || 0 === t.writeResults.length), this._u = !0, this.listener.Eu();
    }
    /**
     ...
     */    Tu() {
        ...
        const t = {};
        t.database = ye(this.serializer), this.Zc(t);
    }
    /** Sends a group of mutations to the Firestore backend to apply. */    du(t) {
        const e = {
...
class Rr extends class {} {
    constructor(t, e, n) {
        super(), this.credentials = t, this.Qc = e, this.serializer = n, this.Iu = !1;
    }
    mu() {
        if (this.Iu) throw new N(C.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    /** Gets an auth token and invokes the provided RPC. */    Au(t, e, n) {
        return this.mu(), this.credentials.getToken().then((s => this.Qc.Au(t, e, n, s))).catch((t => {
            throw t.code === C.UNAUTHENTICATED && this.credentials.m(), t;
        }));
    }
    /** Gets an auth token and invokes the provided RPC with streamed results. */    Ru(t, e, n) {
        return this.mu(), this.credentials.getToken().then((s => this.Qc.Ru(t, e, n, s))).catch((t => {
            throw t.code === C.UNAUTHENTICATED && this.credentials.m(), t;
        }));
    }
    terminate() {
...
class Pr {
     ...
     */    pu() {
        0 === this.gu && (this.vu("Unknown" /* Unknown */), this.yu = this.di.Us("online_state_timeout" /* OnlineStateTimeout */ , 1e4, (() => (this.yu = null, 
        this.bu("Backend didn't respond within 10 seconds."), this.vu("Offline" /* Offline */), 
        Promise.resolve()))));
    }
    /**
    ...
    bu(t) {
        ...
        this.Vu ? (V(e), this.Vu = !1) : y("OnlineStateTracker", e);
    }
    Du() {
 ...
 */ class gr {
    ...
    e, n, s, i) {
        this.Cu = t, this.Nu = e, this.di = n, this.xu = {}, 
        /**
         ...
         */
        this.ku = [], this.$u = i, this.$u.Lu((t => {
            n.Ri((async () => {
                // Porting Note: Unlike iOS, `restartNetwork()` is called even when the
                // network becomes unreachable as we don't have any other way to tear
                // down our streams.
                Nr(this) && (y("RemoteStore", "Restarting streams for network reachability change."), 
                await async function(t) {
                    const e = D(t);
                    e.Mu.add(4 /* ConnectivityChange */), await Vr(e), e.Bu.set("Unknown" /* Unknown */), 
                    e.Mu.delete(4 /* ConnectivityChange */), await yr(e);
                }(this));
            }));
        })), this.Bu = new Pr(n, s);
    }
...
async function yr(t) {
    if (Nr(t)) for (const e of t.ku) await e(/* enabled= */ !0);
}
 ...
 * enableNetwork().
 */ async function Vr(t) {
    for (const e of t.ku) await e(/* enabled= */ !1);
}
 ...
 */ function vr(t, e) {
    const n = D(t), s = Hr(n);
    n.Ou.delete(e), s.zc() && Sr(n, e), 0 === n.Ou.size && (s.zc() ? s.Yc() : Nr(n) && 
 ...
 */ function Cr(t) {
    return Nr(t) && !Hr(t).Gc() && t.Ou.size > 0;
}

function Nr(t) {
    return 0 === D(t).Mu.size;
}
...
async function Mr(t, e, n) {
    ...
    t.Bu.set("Online" /* Online */), e instanceof Ft && 2 /* Removed */ === e.state && e.cause) 
    ...
    try {
        ...
        async function(t, e) {
            ...
            t.Ou.has(s) && (await t.xu.Uu(s, n), t.Ou.delete(s), t.qu.removeTarget(s));
        }
        /**
 ...
 */ (t, e);
        ...
        await kr(t, n);
    } else if (e instanceof Nt ? t.qu.$e(e) : e instanceof xt ? t.qu.je(e) : t.qu.qe(e), 
    !n.isEqual(K.min())) try {
        const e = await ur(t.Cu);
        n.F(e) >= 0 && 
 ...
 */
        function(t, e) {
            ...
            // persistent view of these when applying the completed RemoteEvent.
                ...
                if (n.resumeToken.ht() > 0) {
                    const i = t.Ou.get(s);
                    // A watched target might have been removed already.
                                        i && t.Ou.set(s, i.wt(n.resumeToken, e));
                }
            })), 
        ...
        y("RemoteStore", "Failed to raise snapshot:", e), await kr(t, e);
    }
}
 ...
 */ async function kr(t, e, n) {
    if (!Ss(e)) throw e;
    t.Mu.add(1 /* IndexedDbFailed */), 
    // Disable network and raise offline snapshots
    await Vr(t), t.Bu.set("Offline" /* Offline */), n || (
    ...
    t.di.Mi((async () => {
        y("RemoteStore", "Retrying IndexedDB access"), await n(), t.Mu.delete(1 /* IndexedDbFailed */), 
        await yr(t);
    }));
}
...
function Ur(t) {
    return Nr(t) && !Jr(t).Gc() && t.Fu.length > 0;
}
...
async function Wr(t) {
    ...
    // Send the write pipeline now that the stream is established.
        for (const n of t.Fu) e.du(n.mutations);
}

async function jr(t, e, n) {
    const s = t.Fu.shift(), i = fs.from(s, e, n);
    await $r(t, (() => t.xu.Ku(i))), 
...
async function Gr(t, e) {
    ...
    await async function(t, e) {
        ...
        if (n = e.code, ht(n) && n !== C.ABORTED) {
            ...
            // restart.
                        Jr(t).Jc(), await $r(t, (() => t.xu.Wu(n.batchId, e))), 
...
async function zr(t, e) {
    const n = D(t);
    e ? (n.Mu.delete(2 /* IsSecondary */), await yr(n)) : e || (n.Mu.add(2 /* IsSecondary */), 
    await Vr(n), n.Bu.set("Unknown" /* Unknown */));
}
 ...
 */ function Hr(t) {
    ...
    t.ju = function(t, e, n) {
        const s = D(t);
        return s.mu(), new mr(e, s.Qc, s.credentials, s.serializer, n);
    }
    /**
 * @license
 * Copyright 2018 Google LLC
 ...
 */ (t.Nu, t.di, {
        ...
        e ? (t.ju.Jc(), Cr(t) ? Dr(t) : t.Bu.set("Unknown" /* Unknown */)) : (await t.ju.stop(), 
        xr(t));
    }))), t.ju;
}
 ...
 */ function Jr(t) {
    ...
    t.Gu = function(t, e, n) {
        const s = D(t);
        return s.mu(), new Ar(e, s.Qc, s.credentials, s.serializer, n);
    }(t.Nu, t.di, {
        cu: Kr.bind(null, t),
        nu: Gr.bind(null, t),
        Eu: Wr.bind(null, t),
        ...
        await Lr(t)) : (await t.Gu.stop(), t.Fu.length > 0 && (y("RemoteStore", `Stopping write stream with ${t.Fu.length} pending writes`), 
        t.Fu = []));
    }))), t.Gu;
}
...
async function to(t, e) {
    ...
    if (i) return n.queries.delete(s), n.Zu(s);
}
...
function eo(t, e) {
    ...
    for (const t of e) {
        ...
        if (i) {
            for (const e of i.listeners) e.Xu(t) && (s = !0);
            i.zu = t;
        }
    }
    s && so(n);
 ...
 */ class io {
     ...
     */    Xu(t) {
        ...
        let e = !1;
        return this.ea ? this.sa(t) && (this.ta.next(t), e = !0) : this.ia(t, this.onlineState) && (this.ra(t), 
        e = !0), this.na = t, e;
    }
    onError(t) {
        this.ta.error(t);
    ...
    ra(t) {
        t = St.ie(t.query, t.docs, t.ee, t.fromCache), this.ea = !0, this.ta.next(t);
    }
}
 ...
 */ class ro {
    constructor() {
        ...
        this.ca = new wt(oo.ua), 
        // A set of outstanding references to a document sorted by target id.
        this.aa = new wt(oo.ha);
    }
    ...
    /** Add references to the given document keys for the given ID. */    la(t, e) {
     ...
     * removed.
     */    da(t) {
        const e = new H(new j([])), n = new oo(e, t), s = new oo(e, t + 1), i = [];
        return this.aa.Kt([ n, s ], (t => {
            this._a(t), i.push(t.key);
        })), i;
    }
    wa() {
        this.ca.forEach((t => this._a(t)));
    }
    _a(t) {
        this.ca = this.ca.delete(t), this.aa = this.aa.delete(t);
    }
    Ea(t) {
        const e = new H(new j([])), n = new oo(e, t), s = new oo(e, t + 1);
        let i = yt();
        return this.aa.Kt([ n, s ], (t => {
            i = i.add(t.key);
        })), i;
    ...
    Qr(t) {
        const e = new oo(t, 0), n = this.ca.jt(e);
...
class oo {
    ...
    /** Compare by key then by ID */    static ua(t, e) {
        return H.$(t.key, e.key) || B(t.Ta, e.Ta);
    }
    /** Compare by ID then by key */    static ha(t, e) {
        return B(t.Ta, e.Ta) || H.$(t.key, e.key);
    }
}
...
class ho {
     ...
     */    static Ia(t, e, n) {
        ...
        i && (r = new N(s.error.code, s.error.message))), i ? new ho(t, e, s.state, r) : (V("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    ma() {
        const t = {
...
class lo {
     ...
     */    static Ia(t, e) {
        ...
        s && (i = new N(n.error.code, n.error.message))), s ? new lo(t, n.state, i) : (V("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    ma() {
        const t = {
 ...
 */ class _o {
     ...
     */    static Ia(t, e) {
        ...
        return s ? new _o(t, i) : (V("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
        null);
    }
}
 ...
 */ class fo {
     ...
     */    static Ia(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new fo(e.clientId, e.onlineState) : (V("SharedClientState", "Failed to parse online state: " + t), 
        null);
    }
}
 ...
 */ class Eo {
    constructor(t, e, n, s, i) {
        this.window = t, this.Cs = e, this.persistenceKey = n, this.Pa = s, this.ga = null, 
        this.Pu = null, this.ps = null, this.ya = this.Va.bind(this), this.pa = new _t(B), 
        this.lr = !1, 
        /**
        ...
        const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.ba = co(this.persistenceKey, this.Pa), 
        this.Sa = 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (this.persistenceKey), this.pa = this.pa.Tt(this.Pa, new wo), this.Da = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
        this.Ca = new RegExp(`^firestore_mutations_${r}_(\\d+)(?:_(.*))?$`), this.Na = new RegExp(`^firestore_targets_${r}_(\\d+)$`), 
        this.xa = 
    ...
    async start() {
        ...
        // SharedClientState.
        const t = await this.ga.Ic();
        for (const e of t) {
            if (e === this.Pa) continue;
            const t = this.getItem(co(this.persistenceKey, e));
            if (t) {
                const n = _o.Ia(e, t);
                n && (this.pa = this.pa.Tt(n.clientId, n));
            }
        }
        this.Oa();
        // Check if there is an existing online state and call the callback handler
        // if applicable.
        const e = this.storage.getItem(this.xa);
        if (e) {
            const t = this.Ma(e);
            t && this.ka(t);
        }
        for (const t of this.va) this.Va(t);
        this.va = [], 
        // Register a window unload hook to remove the client metadata entry from
        // WebStorage even if `shutdown()` was not called.
        this.window.addEventListener("unload", (() => this.fc())), this.lr = !0;
    }
    Ss(t) {
    ...
    Wa(t) {
        ...
        // by another tab
                if (this.Ba(t)) {
            const n = this.storage.getItem(ao(this.persistenceKey, t));
            if (n) {
                const s = lo.Ia(t, n);
                s && (e = s.state);
            }
    ...
    Va(t) {
        ...
        if (e.storageArea === this.storage) {
            if (y("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.ba) return void V("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.Cs.Mi((async () => {
                if (this.lr) {
                    if (null !== e.key) if (this.Da.test(e.key)) {
                        if (null == e.newValue) {
                            const t = this.sh(e.key);
                            return this.ih(t, null);
                        }
                        {
                            const t = this.rh(e.key, e.newValue);
                            if (t) return this.ih(t.clientId, t);
                        }
                    } else if (this.Ca.test(e.key)) {
                        if (null !== e.newValue) {
                            const t = this.oh(e.key, e.newValue);
                            if (t) return this.uh(t);
                        }
                    } else if (this.Na.test(e.key)) {
                        if (null !== e.newValue) {
                            const t = this.ah(e.key, e.newValue);
                            if (t) return this.hh(t);
                        }
                    } else if (e.key === this.xa) {
                        if (null !== e.newValue) {
                            const t = this.Ma(e.newValue);
                            if (t) return this.ka(t);
                        }
                    } else if (e.key === this.Sa) {
                        const t = function(t) {
                            let e = ys.Ds;
                            if (null != t) try {
 ...
 */ (e.newValue);
                        t !== ys.Ds && this.ps(t);
                    } else if (e.key === this.Fa) return this.ga.lh();
                } else this.va.push(e);
            }));
        }
    }
    ...
    Ua(t, e, n) {
        const s = new ho(this.currentUser, t, e, n), i = uo(this.persistenceKey, this.currentUser, t);
        this.setItem(i, s.ma());
    }
    Ka(t) {
        const e = uo(this.persistenceKey, this.currentUser, t);
        this.removeItem(e);
    }
    th(t) {
        const e = {
    ...
    Ya(t, e, n) {
        const s = ao(this.persistenceKey, t), i = new lo(t, e, n);
        this.setItem(s, i.ma());
    }
    nh() {
     ...
     * could not be parsed.
     */    oh(t, e) {
        const n = this.Ca.exec(t), s = Number(n[1]), i = void 0 !== n[2] ? n[2] : null;
        return ho.Ia(new R(i), s, e);
    }
    /**
     * Parses a query target state from WebStorage. Returns 'null' if the value
     * could not be parsed.
     */    ah(t, e) {
        const n = this.Na.exec(t), s = Number(n[1]);
        return lo.Ia(s, e);
    }
    /**
    ...
    async uh(t) {
        if (t.user.uid === this.currentUser.uid) return this.ga._h(t.batchId, t.state, t.error);
    ...
    ih(t, e) {
        const n = e ? this.pa.Tt(t, e) : this.pa.remove(t), s = this.La(this.pa), i = this.La(n), r = [], o = [];
        return i.forEach((t => {
            s.has(t) || r.push(t);
        })), s.forEach((t => {
            i.has(t) || o.push(t);
...
class To {
    constructor() {
        this.wh = new wo, this.Eh = {}, this.Pu = null, this.ps = null;
    }
    qa(t) {
        // No op.
    }
    ...
    start() {
        return this.wh = new wo, Promise.resolve();
    }
    Xa(t, e, n) {
        // No op.
    }
 ...
 */ class Ao {
    ...
    e) {
        ...
        this.ee = yt(), this.Ah = zn(t), this.Rh = new vt(this.Ah);
    }
    /**
     ...
     */    gh(t, e) {
        const n = e ? e.yh : new bt, s = e ? e.Rh : this.Rh;
        ...
        if (t.Pt(((t, e) => {
            ...
            // Calculate change
                ...
                a.data().isEqual(h.data()) ? l !== _ && (n.track({
                    type: 3 /* Metadata */ ,
                    doc: h
                }), f = !0) : this.Vh(a, h) || (n.track({
                    type: 2 /* Modified */ ,
                    doc: h
                }), f = !0, (c && this.Ah(h, c) > 0 || u && this.Ah(h, u) < 0) && (
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (t.type, e.type) || this.Ah(t.doc, e.doc))), this.bh(n);
        const r = e ? this.Sh() : [], o = 0 === this.mh.size && this.le ? 1 /* Synced */ : 0 /* Local */ , c = o !== this.Ih;
        if (this.Ih = o, 0 !== i.length || c) {
            return {
                snapshot: new St(this.query, t.Rh, s, i, t.ee, 0 /* Local */ === o, c, 
                /* excludesMetadataChanges= */ !1),
                Dh: r
            };
        }
     ...
     */    bh(t) {
        t && (t._e.forEach((t => this.Th = this.Th.add(t))), t.fe.forEach((t => {})), t.de.forEach((t => this.Th = this.Th.delete(t))), 
        this.le = t.le);
    }
    Sh() {
        ...
        // updating many documents.
                const t = this.mh;
        this.mh = yt(), this.Rh.forEach((t => {
            this.Ch(t.key) && (this.mh = this.mh.add(t.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        const e = [];
        return t.forEach((t => {
            this.mh.has(t) || e.push(new mo(t));
        })), this.mh.forEach((n => {
            t.has(n) || e.push(new Io(n));
        })), e;
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    Nh(t) {
        this.Th = t.Bc, this.mh = yt();
        const e = this.gh(t.documents);
    ...
    // PORTING NOTE: Multi-tab only.
    xh() {
        return St.ie(this.query, this.Rh, this.ee, 0 /* Local */ === this.Ih);
    }
}
...
/** Tracks a limbo resolution. */ class Po {
    constructor(t) {
        this.key = t, 
        /**
 ...
 */ class go {
    ...
    s, i, r) {
        this.Cu = t, this.Oh = e, this.Mh = n, this.kh = s, this.currentUser = i, this.$h = r, 
        this.Lh = {}, this.Bh = new ds((t => Wn(t)), Kn), this.qh = new Map, 
        /**
         ...
         */
        this.Kh = new Map, this.Wh = new ro, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.jh = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Gh = new Map, this.zh = Wi._o(), this.onlineState = "Unknown" /* Unknown */ , 
...
async function yo(t, e) {
    ...
    s = r.targetId, n.kh.Wa(s), i = r.view.xh(); else {
        const t = await lr(n.Cu, Un(e)), r = n.kh.Wa(t.targetId);
        s = t.targetId, i = await Vo(n, e, s, "current" === r), n.Jh && pr(n.Oh, t);
    }
    return i;
}
 ...
 * snapshot.
 */ async function Vo(t, e, n, s) {
    // PORTING NOTE: On Web only, we inject the code that registers new Limbo
    // targets based on view changes. This allows us to only depend on Limbo
    // changes when user code includes queries.
    t.Yh = (e, n, s) => async function(t, e, n, s) {
        let i = e.view.gh(n);
        i.ph && (
        // The query has a limit and some docs were removed, so we need
        // to re-run the query against the local store to make sure we
        // didn't lose any good docs that had been past the limit.
        i = await fr(t.Cu, e.query, 
        /* usePreviousResults= */ !1).then((({documents: t}) => e.view.gh(t, i))));
        const r = s && s.re.get(e.targetId), o = e.view.Zn(i, 
        /* updateLimboDocuments= */ t.Jh, r);
        return $o(t, e.targetId, o.Dh), o.snapshot;
    }(t, e, n, s);
    const i = await fr(t.Cu, e, 
    /* usePreviousResults= */ !0), r = new Ao(e, i.Bc), o = r.gh(i.documents), c = Ct.he(n, s && "Offline" /* Offline */ !== t.onlineState), u = r.Zn(o, 
    /* updateLimboDocuments= */ t.Jh, c);
    $o(t, n, u.Dh);
    const a = new Ro(e, n, r);
    return t.Bh.set(e, a), t.qh.has(n) ? t.qh.get(n).push(e) : t.qh.set(n, [ e ]), u.snapshot;
}

/** Stops listening to the query. */ async function po(t, e) {
    const n = D(t), s = n.Bh.get(e), i = n.qh.get(s.targetId);
    if (i.length > 1) return n.qh.set(s.targetId, i.filter((t => !Kn(t, e)))), void n.Bh.delete(e);
    // No other queries are mapped to the target, clean up the query and the target.
        if (n.Jh) {
        // We need to remove the local query target first to allow us to verify
        // whether any other client is still interested in this target.
        n.kh.Ga(s.targetId);
        n.kh.Ba(s.targetId) || await _r(n.Cu, s.targetId, 
        /*keepPersistedTargetData=*/ !1).then((() => {
            n.kh.Ha(s.targetId), vr(n.Oh, s.targetId), Mo(n, s.targetId);
        })).catch(Tr);
    } else Mo(n, s.targetId), await _r(n.Cu, s.targetId, 
 ...
 */ async function vo(t, e, n) {
    ...
    try {
        const t = await function(t, e) {
            ...
            let r;
            return n.persistence.runTransaction("Locally write mutations", "readwrite", (t => n.Oc._s(t, i).next((i => {
                r = i;
        ...
        s.kh.qa(t.batchId), function(t, e, n) {
            let s = t.jh[t.currentUser.h()];
            s || (s = new _t(B));
            s = s.Tt(e, n), t.jh[t.currentUser.h()] = s;
        }
        /**
 * Resolves or rejects the user callback for the given batch and then discards
 * it.
 */ (s, t.batchId, n), await qo(s, t.Qn), await Lr(s.Oh);
    } catch (t) {
 ...
 */ async function bo(t, e) {
    ...
    try {
        ...
        // Update `receivedDocument` as appropriate for any limbo targets.
            ...
            S(t._e.size + t.fe.size + t.de.size <= 1), t._e.size > 0 ? s.Fh = !0 : t.fe.size > 0 ? S(s.Fh) : t.de.size > 0 && (S(s.Fh), 
            s.Fh = !1));
        })), await qo(n, t, e);
    } catch (t) {
        await Tr(t);
 ...
 */ function So(t, e, n) {
    ...
    // SharedClientState.
        if (s.Jh && 0 /* RemoteStore */ === n || !s.Jh && 1 /* SharedClientState */ === n) {
        const t = [];
        s.Bh.forEach(((n, s) => {
            const i = s.view.Yu(e);
        ...
        }(s.Mh, e), t.length && s.Lh.au(t), s.onlineState = e, s.Jh && s.kh.Za(e);
    }
}
 ...
 */ async function Do(t, e, n) {
    ...
    if (r) {
        ...
        s.Qh = s.Qh.remove(r), s.Kh.delete(e), Bo(s);
    } else await _r(s.Cu, e, 
    /* keepPersistedTargetData */ !1).then((() => Mo(s, e, n))).catch(Tr);
}

async function Co(t, e) {
    const n = D(t), s = e.batch.batchId;
    try {
        const t = await cr(n.Cu, e);
        // The local store may or may not be able to apply the write result and
        // raise events immediately (depending on whether the watcher is caught
        // up), so we raise user callbacks first so that they consistently happen
        // before listen events.
                Oo(n, s, /*error=*/ null), Fo(n, s), n.kh.Qa(s, "acknowledged"), await qo(n, t);
    } catch (t) {
        await Tr(t);
    }
}
    ...
    try {
        const t = await function(t, e) {
            ...
            return n.persistence.runTransaction("Reject batch", "readwrite-primary", (t => {
                let s;
                return n.rs.Cr(t, e).next((e => (S(null !== e), s = e.keys(), n.rs.$r(t, e)))).next((() => n.rs.Ur(t))).next((() => n.Oc._s(t, s)));
            }));
        }
        /**
 ...
 */ (s.Cu, e);
        ...
        // listen events.
                Oo(s, e, n), Fo(s, e), s.kh.Qa(e, "rejected", n), await qo(s, t);
    } catch (n) {
        await Tr(n);
    }
}
 ...
 */ async function xo(t, e) {
    const n = D(t);
    Nr(n.Oh) || y("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
    try {
        const t = await function(t) {
            const e = D(t);
            return e.persistence.runTransaction("Get highest unacknowledged batch id", "readonly", (t => e.rs.Or(t)));
        }(n.Cu);
        if (-1 === t) 
        // Trigger the callback right away if there is no pending writes at the moment.
        return void e.resolve();
        const s = n.Gh.get(t) || [];
        s.push(e), n.Gh.set(t, s);
    } catch (t) {
 ...
 * if there are any.
 */ function Fo(t, e) {
    (t.Gh.get(e) || []).forEach((t => {
        t.resolve();
    })), t.Gh.delete(e);
}

/** Reject all outstanding callbacks waiting for pending writes to complete. */ function Oo(t, e, n) {
    const s = D(t);
    let i = s.jh[s.currentUser.h()];
    // NOTE: Mutations restored from persistence won't have callbacks, so it's
    // okay for there to be no callback for this ID.
        if (i) {
        const t = i.get(e);
        t && (n ? t.reject(n) : t.resolve(), i = i.remove(e)), s.jh[s.currentUser.h()] = i;
    }
}

function Mo(t, e, n = null) {
    t.kh.Ga(e);
    for (const s of t.qh.get(e)) t.Bh.delete(s), n && t.Lh.Xh(s, n);
    if (t.qh.delete(e), t.Jh) {
        t.Wh.da(e).forEach((e => {
            t.Wh.Qr(e) || 
...
function ko(t, e) {
    ...
    const n = t.Qh.get(e);
    null !== n && (vr(t.Oh, n), t.Qh = t.Qh.remove(e), t.Kh.delete(n), Bo(t));
}

function $o(t, e, n) {
    for (const s of n) if (s instanceof Io) t.Wh.Do(s.key, e), Lo(t, s); else if (s instanceof mo) {
        y("SyncEngine", "Document no longer in limbo: " + s.key), t.Wh.No(s.key, e);
        t.Wh.Qr(s.key) || 
        // We removed the last reference for this key
        ko(t, s.key);
    } else b();
...
function Lo(t, e) {
    const n = e.key;
    t.Qh.get(n) || (y("SyncEngine", "New document in limbo: " + n), t.Uh.push(n), Bo(t));
}
 ...
 */ function Bo(t) {
    for (;t.Uh.length > 0 && t.Qh.size < t.$h; ) {
        const e = t.Uh.shift(), n = t.zh.next();
        t.Kh.set(n, new Po(e)), t.Qh = t.Qh.Tt(e, n), pr(t.Oh, new ot(Un(On(e.path)), n, 2 /* LimboResolution */ , ys.Ds));
    }
}

async function qo(t, e, n) {
    const s = D(t), i = [], r = [], o = [];
    s.Bh.W() || (s.Bh.forEach(((t, c) => {
        o.push(s.Yh(c, e, n).then((t => {
            if (t) {
                s.Jh && s.kh.Ja(c.targetId, t.fromCache ? "not-current" : "current"), i.push(t);
                const e = gs.Vs(c.targetId, t);
                r.push(e);
            }
        })));
    })), await Promise.all(o), s.Lh.au(i), await async function(t, e) {
        const n = D(t);
        try {
            await n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (t => ws.forEach(e, (e => ws.forEach(e.gs, (s => n.persistence.Vr.Do(t, e.targetId, s))).next((() => ws.forEach(e.ys, (s => n.persistence.Vr.No(t, e.targetId, s)))))))));
        } catch (t) {
            if (!Ss(t)) throw t;
        ...
        for (const t of e) {
            const e = t.targetId;
            if (!t.fromCache) {
                const t = n.Cc.get(e), s = t.ft, i = t.Et(s);
...
async function Uo(t, e) {
    ...
    if (!n.currentUser.isEqual(e)) {
        ...
        n.kh.Xa(e, t.$c, t.Lc), await qo(n, t.kc);
    }
}

function Qo(t, e) {
    const n = D(t), s = n.Kh.get(e);
    if (s && s.Fh) return yt().add(s.key);
    {
        let t = yt();
        const s = n.qh.get(e);
        if (!s) return t;
 ...
 */ async function Ko(t, e) {
    const n = D(t), s = await fr(n.Cu, e.query, 
    /* usePreviousResults= */ !0), i = e.view.Nh(s);
    return n.Jh && $o(n, e.targetId, i.Dh), i;
}
...
async function Wo(t) {
    const e = D(t);
    return wr(e.Cu).then((t => qo(e, t)));
}

/** Applies a mutation state to an existing batch.  */
// PORTING NOTE: Multi-Tab only.
async function jo(t, e, n, s) {
    const i = D(t), r = await function(t, e) {
        const n = D(t), s = D(n.rs);
        return n.persistence.runTransaction("Lookup mutation documents", "readonly", (t => s.Nr(t, e).next((e => e ? n.Oc._s(t, e) : ws.resolve(null)))));
    }
    // PORTING NOTE: Multi-Tab only.
    (i.Cu, e);
    null !== r ? ("pending" === n ? 
    ...
    await Lr(i.Oh) : "acknowledged" === n || "rejected" === n ? (
    // NOTE: Both these methods are no-ops for batches that originated from
    // other clients.
    Oo(i, e, s || null), Fo(i, e), function(t, e) {
        D(D(t).rs).Br(e);
    }
    // PORTING NOTE: Multi-Tab only.
    (i.Cu, e)) : b(), await qo(i, r)) : 
...
async function Go(t, e) {
    ...
    if (Zo(n), tc(n), !0 === e && !0 !== n.Hh) {
        ...
        const t = n.kh.$a(), e = await zo(n, t.H());
        n.Hh = !0, await zr(n.Oh, !0);
        for (const t of e) pr(n.Oh, t);
    } else if (!1 === e && !1 !== n.Hh) {
        const t = [];
        let e = Promise.resolve();
        n.qh.forEach(((s, i) => {
            n.kh.za(i) ? t.push(i) : e = e.then((() => (Mo(n, i), _r(n.Cu, i, 
            /*keepPersistedTargetData=*/ !0)))), vr(n.Oh, i);
        ...
        function(t) {
            ...
            e.Kh.forEach(((t, n) => {
                vr(e.Oh, n);
            })), e.Wh.wa(), e.Kh = new Map, e.Qh = new _t(H.$);
        }
        /**
...
async function zo(t, e, n) {
    ...
    for (const t of e) {
        ...
        if (n && 0 !== n.length) {
            ...
            e = await lr(s.Cu, Un(n[0]));
            for (const t of n) {
                const e = s.Bh.get(t), n = await Ko(s, e);
                n.snapshot && r.push(n.snapshot);
            }
        } else {
            // For queries that never executed on this client, we need to
            // allocate the target in LocalStore and initialize a new View.
            const n = await dr(s.Cu, t);
            e = await lr(s.Cu, n), await Vo(s, Ho(n), t, 
            /*current=*/ !1);
        }
        i.push(e);
    }
...
function Jo(t) {
    const e = D(t);
    return D(D(e.Cu).persistence).Ic();
}
...
async function Yo(t, e, n, s) {
    ...
    y("SyncEngine", "Ignoring unexpected query state notification."); else if (i.qh.has(e)) switch (n) {
      case "current":
      case "not-current":
        {
            const t = await wr(i.Cu), s = Dt.ae(e, "current" === n);
            await qo(i, t, s);
            break;
        }
      ...
      case "rejected":
        await _r(i.Cu, e, 
        /* keepPersistedTargetData */ !0), Mo(i, e, s);
        break;
...
/** Adds or removes Watch targets for queries from different tabs. */ async function Xo(t, e, n) {
    const s = Zo(t);
    if (s.Hh) {
        for (const t of e) {
            if (s.qh.has(t)) {
            ...
            const e = await dr(s.Cu, t), n = await lr(s.Cu, e);
            await Vo(s, Ho(e), n.targetId, 
            /*current=*/ !1), pr(s.Oh, n);
        }
        for (const t of n) 
...
function Zo(t) {
    const e = D(t);
    return e.Oh.xu.Qu = bo.bind(null, e), e.Oh.xu.Xe = Qo.bind(null, e), e.Oh.xu.Uu = Do.bind(null, e), 
    e.Lh.au = eo.bind(null, e.Mh), e.Lh.Xh = no.bind(null, e.Mh), e;
}

function tc(t) {
    const e = D(t);
    return e.Oh.xu.Ku = Co.bind(null, e), e.Oh.xu.Wu = No.bind(null, e), e;
}
 ...
 */ class ec {
    ...
    ws(t, e, s, i) {
        ...
        }(e) || s.isEqual(K.min()) ? this.tl(t, e) : this.Zh._s(t, i).next((r => {
            const o = this.el(e, r);
            return (Mn(e) || kn(e)) && this.ph(e.limitType, o, i, s) ? this.tl(t, e) : (g() <= n.DEBUG && y("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", s.toString(), jn(e)), 
            this.Zh.ws(t, e, s).next((t => (
    ...
    /** Applies the query filter and sorting to the provided documents.  */    el(t, e) {
    ...
    tl(t, e) {
        return g() <= n.DEBUG && y("IndexFreeQueryEngine", "Using full collection scan to execute query:", jn(e)), 
        this.Zh.ws(t, e, K.min());
    }
}
 ...
 */ class nc {
    ...
    Sr(t, e, n, s) {
        ...
        for (const e of s) this.sl = this.sl.add(new oo(e.key, i)), this.os.Dr(t, e.key.path.q());
        return ws.resolve(r);
    }
    Cr(t, e) {
    ...
    us(t, e) {
        const n = new oo(e, 0), s = new oo(e, Number.POSITIVE_INFINITY), i = [];
        return this.sl.Kt([ n, s ], (t => {
            const e = this.il(t.Ta);
            i.push(e);
        })), ws.resolve(i);
    }
    ds(t, e) {
        let n = new wt(B);
        return e.forEach((t => {
            const e = new oo(t, 0), s = new oo(t, Number.POSITIVE_INFINITY);
            this.sl.Kt([ e, s ], (t => {
                n = n.add(t.Ta);
            }));
    ...
    $r(t, e) {
        ...
        return ws.forEach(e.mutations, (s => {
            const i = new oo(s.key, e.batchId);
            return n = n.delete(i), this.Vr.qr(t, s.key);
        })).next((() => {
            this.sl = n;
        }));
    }
    ...
    Qr(t, e) {
        const n = new oo(e, 0), s = this.sl.jt(n);
...
class sc {
     ...
     */    jn(t, e, n) {
        ...
        return this.docs = this.docs.Tt(s, {
            ...
            size: o,
            readTime: n
        }), this.size += o - r, this.os.Dr(t, s.path.q());
    }
    /**
...
class ic extends Es {
    ...
    Zn(t) {
        ...
        return this.Qn.forEach(((n, s) => {
            s && s.zn ? e.push(this.no.jn(t, s.zn, this.Wn(n))) : this.no.Hn(n);
        })), ws.qn(e);
    }
    Yn(t, e) {
 ...
 */ class rc {
    constructor(t) {
         ...
         * IDs.
         */
        this._l = new ro, this.targetCount = 0, this.fl = Wi.lo();
    }
    Ue(t, e) {
    ...
    Ro(t) {
        ...
        const e = t.targetId;
        e > this.highestTargetId && (this.fl = new Wi(e), this.highestTargetId = e), t.sequenceNumber > this.ll && (this.ll = t.sequenceNumber);
    }
    Ao(t, e) {
        return this.Ro(e), this.targetCount += 1, ws.resolve();
    }
    yo(t, e) {
        return this.Ro(e), ws.resolve();
    }
    Vo(t, e) {
    ...
    mr(t, e, n) {
        ...
        return this.hl.forEach(((r, o) => {
            o.sequenceNumber <= e && null === n.get(o.targetId) && (this.hl.delete(r), i.push(this.po(t, o.targetId)), 
            s++);
        })), ws.qn(i).next((() => s));
    }
    vo(t) {
    ...
    So(t, e, n) {
        return this._l.la(e, n), ws.resolve();
    }
    Co(t, e, n) {
        this._l.fa(e, n);
        const s = this.persistence.Vr, i = [];
        return s && e.forEach((e => {
            i.push(s.qr(t, e));
        })), ws.qn(i);
    }
    po(t, e) {
        return this._l.da(e), ws.resolve();
    }
    xo(t, e) {
        const n = this._l.Ea(e);
        return ws.resolve(n);
    }
    Qr(t, e) {
        return ws.resolve(this._l.Qr(e));
    }
}
...
class cc {
     ...
     */
    constructor(t, e) {
        this.El = {}, this.ko = new ys(0), this.$o = !1, this.$o = !0, this.Vr = t(this), 
        this.jo = new rc(this);
        this.os = new mi, this.ss = function(t, e) {
            return new sc(t, e);
        }(this.os, (t => this.Vr.Tl(t))), this.serializer = new Js(e), this.Go = new oc(this.serializer);
    }
    start() {
    ...
    mc(t) {
        let e = this.El[t.h()];
        return e || (e = new nc(this.os, this.Vr), this.El[t.h()] = e), e;
    }
    Ac() {
        return this.jo;
    }
    ...
    runTransaction(t, e, n) {
        ...
        const s = new uc(this.ko.next());
        return this.Vr.Il(), n(s).next((t => this.Vr.ml(s).next((() => t)))).Ln().then((t => (s.ns(), 
        t)));
    }
    Al(t, e) {
        return ws.Un(Object.values(this.El).map((n => () => n.Qr(t, e))));
    }
}
...
class ac {
    ...
    Do(t, e, n) {
        return this.Rl.Do(n, e), this.yl.delete(n.toString()), ws.resolve();
    }
    No(t, e, n) {
        return this.Rl.No(n, e), this.yl.add(n.toString()), ws.resolve();
    }
    qr(t, e) {
        return this.yl.add(e.toString()), ws.resolve();
    }
    removeTarget(t, e) {
        this.Rl.da(e.targetId).forEach((t => this.yl.add(t.toString())));
        const n = this.persistence.Ac();
    ...
    ml(t) {
        ...
        const e = this.persistence.Rc().Xr();
    ...
    Vl(t, e) {
        return ws.Un([ () => ws.resolve(this.Rl.Qr(e)), () => this.persistence.Ac().Qr(t, e), () => this.persistence.Al(t, e) ]);
    }
}
...
class wc {
    ...
    async initialize(t) {
        this.serializer = Is(t.Fl.t), this.kh = this.jl(t), this.persistence = this.Gl(t), 
        await this.persistence.start(), this.zl = this.Hl(t), this.Cu = this.Jl(t);
    }
    Hl(t) {
        return null;
    }
    Jl(t) {
        return rr(this.persistence, new ec, t.Yl, this.serializer);
    }
    Gl(t) {
    ...
    async terminate() {
        this.zl && this.zl.stop(), await this.kh.fc(), await this.persistence.fc();
    }
}
 ...
 */ class Ec extends wc {
    ...
    async initialize(t) {
        await super.initialize(t), await Er(this.Cu), await this.Xl.initialize(this, t), 
        // Enqueue writes from a previous session
        await tc(this.Xl.ga), await Lr(this.Xl.Oh);
    }
    Jl(t) {
        return rr(this.persistence, new ec, t.Yl, this.serializer);
    }
    Hl(t) {
        const e = this.persistence.Vr.cr;
        return new Ks(e, t.di);
    }
    Gl(t) {
        const e = sr(t.Fl.t, t.Fl.persistenceKey), n = void 0 !== this.cacheSizeBytes ? Qs.er(this.cacheSizeBytes) : Qs.ir;
        return new Xi(this.synchronizeTabs, e, t.clientId, n, t.di, Os(), Ms(), this.serializer, this.kh, !!this.forceOwnership);
    }
    jl(t) {
        return new To;
    }
 ...
 */ class Tc extends Ec {
    ...
    async initialize(t) {
        ...
        const e = this.Xl.ga;
        this.kh instanceof Eo && (this.kh.ga = {
            _h: jo.bind(null, e),
            fh: Yo.bind(null, e),
            dh: Xo.bind(null, e),
            Ic: Jo.bind(null, e),
        ...
        await this.persistence.Zo((async t => {
            await Go(this.Xl.ga, t), this.zl && (t && !this.zl.lr ? this.zl.start(this.Cu) : t || this.zl.stop());
        }));
    }
    jl(t) {
        const e = Os();
        if (!Eo.Gs(e)) throw new N(C.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        const n = sr(t.Fl.t, t.Fl.persistenceKey);
        return new Eo(e, t.di, n, t.clientId, t.Yl);
    }
}
 ...
 */ class Ic {
    async initialize(t, e) {
        this.Cu || (this.Cu = t.Cu, this.kh = t.kh, this.Nu = this.Zl(e), this.Oh = this.t_(e), 
        this.Mh = this.e_(e), this.ga = this.n_(e, 
        /* startAsPrimary=*/ !t.synchronizeTabs), this.kh.Pu = t => So(this.ga, t, 1 /* SharedClientState */), 
        this.Oh.xu.s_ = Uo.bind(null, this.ga), await zr(this.Oh, this.ga.Jh));
    }
    e_(t) {
        return new Xr;
    }
    ...
    t_(t) {
        return e = this.Cu, n = this.Nu, s = t.di, i = t => So(this.ga, t, 0 /* RemoteStore */), 
        r = fc.Gs() ? new fc : new dc, new gr(e, n, s, i, r);
        var e, n, s, i, r;
    ...
    terminate() {
        return async function(t) {
            const e = D(t);
            y("RemoteStore", "RemoteStore shutting down."), e.Mu.add(5 /* Shutdown */), await Vr(e), 
            e.$u.fc(), 
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
e) {
    if (t instanceof Ac && (t = t.o_), !(t instanceof e)) {
...
class xc extends Sc {
    ...
    u_(t) {
        const e = Cc(this, t, 
        /*array=*/ !0), n = this.f_.map((t => zu(t, e))), s = new Xe(n);
...
class Fc extends Sc {
    ...
    u_(t) {
        const e = Cc(this, t, 
        /*array=*/ !0), n = this.f_.map((t => zu(t, e))), s = new tn(n);
        return new cn(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class Oc extends Sc {
    ...
    u_(t) {
        const e = new nn(t.serializer, fe(t.serializer, this.d_));
 ...
 */ class Mc {
     ...
     * with an underscore.
     */    C(t) {
        return B(this.w_, t.w_) || B(this.E_, t.E_);
    }
}
 ...
 */ class kc {
     ...
     */    static fromBase64String(t) {
        try {
            return new kc(rt.fromBase64String(t));
        } catch (t) {
     ...
     */    static fromUint8Array(t) {
        return new kc(rt.fromUint8Array(t));
    }
    /**
 ...
 */ class Bc {
    constructor(t, e) {
        this.I_ = "(lite)", this.m_ = new Lc({}), this.A_ = !1, t instanceof A ? (this.R_ = t, 
        this.P_ = new F) : (this.g_ = t, this.R_ = function(t) {
     ...
     * instance.
     */    get app() {
        if (!this.g_) throw new N(C.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this.g_;
    }
    get y_() {
        return this.A_;
    ...
    v_(t) {
        if (this.A_) throw new N(C.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
        this.m_ = new Lc(t), void 0 !== t.credentials && (this.P_ = function(t) {
            if (!t) return new F;
            switch (t.type) {
              case "gapi":
                const e = t.client;
...
/** Immutable class holding a blob (binary data) */ class Qc extends Ac {
    static fromBase64String(t) {
        return Uc(), new Qc(kc.fromBase64String(t));
    }
    static fromUint8Array(t) {
        return qc(), new Qc(kc.fromUint8Array(t));
    }
    toBase64() {
 ...
 */ class Kc {
    C_(t, e = "none") {
        switch (jt(t)) {
          ...
          case 6 /* BlobValue */ :
            return this.F_(ee(t.bytesValue));
    ...
    M_(t) {
        return new Mc(te(t.latitude), te(t.longitude));
    }
    k_(t, e) {
        return (t.values || []).map((t => this.C_(t, e)));
    }
    x_(t, e) {
        switch (e) {
          case "previous":
...
class Wc extends Kc {
    ...
    F_(t) {
        return new Qc(new kc(t));
    }
    O_(t) {
        const e = this.B_(t, this.firestore.R_);
        return va.q_(e, this.firestore, /* converter= */ null);
    }
}
 ...
 */ class jc {
    ...
    constructor(t, e, n, s, i) {
        this.U_ = t, this.Q_ = e, this.K_ = n, this.W_ = s, this.j_ = i;
    }
     ...
     */    get ref() {
        return new Eu(this.U_, this.j_, this.K_);
    }
    /**
     ...
     */    data() {
        if (this.W_) {
            if (this.j_) {
                ...
                const t = new Gc(this.U_, this.Q_, this.K_, this.W_, 
                /* converter= */ null);
    ...
    get(t) {
        if (this.W_) {
            const e = this.W_.data().field(zc("DocumentSnapshot.get", t));
 ...
 */ function zc(t, e) {
    return "string" == typeof e ? ta(t, e) : e instanceof Ac ? e.o_.G_ : e.G_;
}
...
class Jc extends Bc {
    constructor(t, e) {
        super(t, e), this.z_ = new $s, this.I_ = "name" in t ? t.name : "[DEFAULT]";
    }
    D_() {
        return this.H_ || 
        // The client must be initialized to ensure that all subsequent API
        // usage throws an exception.
        ya(this), this.H_.terminate();
    }
}
...
function Xc(t) {
    if (t.y_ && !t.V_) throw new N(C.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
    const e = new Ts;
    return t.z_.Ni((async () => {
        try {
            await async function(t) {
 ...
 */
    return function(t) {
        const e = new Ts;
        return t.di.Ri((async () => xo(await fa(t), e))), e.promise;
    }(ga(t));
}
 ...
 */ function tu(t) {
    ...
    return function(t) {
        return t.di.enqueue((async () => {
            ...
            return e.ec(!0), function(t) {
                const e = D(t);
                return e.Mu.delete(0 /* UserDisabled */), yr(e);
            }(n);
        }));
    }
    /** Disables the network connection. Pending operations will not complete. */ (ga(t));
}
 ...
 */ function eu(t) {
    return function(t) {
        return t.di.enqueue((async () => {
            const e = await ha(t), n = await _a(t);
            return e.ec(!1), async function(t) {
                const e = D(t);
                e.Mu.add(0 /* UserDisabled */), await Vr(e), 
...
function nu(t) {
    if (t.y_ || t.V_) throw new N(C.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
 ...
 */ class su extends jc {
    constructor(t, e, n, s, i, r) {
        super(t, e, n, s, r), this.U_ = t, this.J_ = t, this.metadata = i;
    }
    /**
     ...
     */    data(t = {}) {
        if (this.W_) {
            if (this.j_) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                const e = new iu(this.U_, this.Q_, this.K_, this.W_, this.metadata, 
                /* converter= */ null);
    ...
    get(t, e = {}) {
        if (this.W_) {
            const n = this.W_.data().field(zc("DocumentSnapshot.get", t));
 ...
 */ class ru {
    constructor(t, e, n, s) {
        this.U_ = t, this.Q_ = e, this.Y_ = s, this.metadata = new Ca(s.hasPendingWrites, s.fromCache), 
        this.query = n;
    }
     ...
     */    forEach(t, e) {
        this.Y_.docs.forEach((n => {
            t.call(e, new iu(this.U_, this.Q_, n.key, n, new Ca(this.Y_.ee.has(n.key), this.Y_.fromCache), this.query.j_));
        }));
    }
    /**
     ...
     */    docChanges(t = {}) {
        ...
        if (e && this.Y_.se) throw new N(C.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function(t, e) {
            if (t.Y_.te.W()) {
                ...
                // fast
                let e, n = 0;
                return t.Y_.docChanges.map((s => {
                    const i = new iu(t.U_, t.Q_, s.doc.key, s.doc, new Ca(t.Y_.ee.has(s.doc.key), t.Y_.fromCache), t.query.j_);
                    return e = s.doc, {
                        type: "added",
                        doc: i,
                        oldIndex: -1,
            ...
            }
            {
                ...
                let n = t.Y_.te;
                return t.Y_.docChanges.filter((t => e || 3 /* Metadata */ !== t.type)).map((e => {
                    const s = new iu(t.U_, t.Q_, e.doc.key, e.doc, new Ca(t.Y_.ee.has(e.doc.key), t.Y_.fromCache), t.query.j_);
                    let i = -1, r = -1;
 ...
 */ function cu(t, e) {
    return t instanceof su && e instanceof su ? t.U_ === e.U_ && t.K_.isEqual(e.K_) && (null === t.W_ ? null === e.W_ : t.W_.isEqual(e.W_)) && t.j_ === e.j_ : t instanceof ru && e instanceof ru && (t.U_ === e.U_ && Mu(t.query, e.query) && t.metadata.isEqual(e.metadata) && t.Y_.isEqual(e.Y_));
}
 ...
 * current document contents.
 */ function au(t) {
    const e = vc(t.firestore, Jc), n = ga(e), s = new uu(e), i = new Ts;
    return e.z_.Ri((async () => {
        const e = await la(n);
        await async function(t, e, n) {
            try {
                const s = await function(t, e) {
                    const n = D(t);
                    return n.persistence.runTransaction("read document", "readonly", (t => n.Oc.cs(t, e)));
                }(t, e);
 ...
 * SnapshotListener.
 */ (e, t.K_, i);
    })), i.promise.then((n => new su(e, s, t.K_, n, new Ca(n instanceof Dn && n.an, 
    /* fromCache= */ !0), t.j_)));
}
...
function hu(t) {
    ...
    return e.z_.Ri((async () => {
        ...
        await async function(t, e, n) {
            try {
                const s = await fr(t, e, 
                /* usePreviousResults= */ !0), i = new Ao(e, s.Bc), r = i.gh(s.documents), o = i.Zn(r, 
                /* updateLimboDocuments= */ !1);
 ...
 * SnapshotListener.
 */ (e, t.tf, i);
    })), i.promise.then((n => new ru(e, s, t, n)));
}
 ...
 * @return A Promise that will be resolved with the results of the query.
 */ function lu(t, e, n, ...s) {
    const i = vc(t.firestore, Jc), r = ku(i);
    let o;
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e instanceof Ac && (e = e.o_), o = "string" == typeof e || e instanceof Hc ? ju(r, "updateDoc", t.K_, e, n, s) : Wu(r, "updateDoc", t.K_, e);
    return du(i, o.ef(t.K_, hn.exists(!0)));
}
 ...
 */ function _u(t, ...e) {
    ...
    let u, a, h;
    if (t instanceof Eu) a = vc(t.firestore, Jc), h = On(t.K_.path), u = {
        next: n => {
            e[o] && e[o](wu(a, t, n));
        },
        error: e[o + 1],
        ...
        a = vc(t.firestore, Jc), h = t.tf;
        const n = new uu(a);
        u = {
            next: s => {
                e[o] && e[o](new ru(a, n, t, s));
            },
            error: e[o + 1],
            complete: e[o + 2]
        }, Su(t.tf);
    }
    const l = ga(a), _ = new mc(u), f = new io(h, _, c);
    return a.z_.Ri((async () => Zr(await da(l), f))), () => {
        _.r_(), a.z_.Ri((async () => to(await da(l), f)));
    };
}

function fu(t, e) {
    const n = ga(t), s = ms(e) ? e : {
        next: e
    }, i = new mc(s);
    return t.z_.Ri((async () => {
        !function(t, e) {
            D(t).Hu.add(e), 
...
/** Locally writes `mutations` on the async queue. */ function du(t, e) {
    return function(t, e) {
        const n = new Ts;
        return t.di.Ri((async () => vo(await fa(t), e, n))), n.promise;
    }
    /**
 ...
 */ function wu(t, e, n) {
    const s = n.docs.get(e.K_), i = new uu(t);
    return new su(t, i, e.K_, s, new Ca(n.hasPendingWrites, n.fromCache), e.j_);
}
 ...
 */ class Eu {
     ...
     */    get parent() {
        return new Du(this.firestore, this.j_, this.K_.path.q());
    }
    /**
     ...
     */    withConverter(t) {
        return new Eu(this.firestore, t, this.K_);
    }
}
 ...
 */ class Tu {
     ...
     */    withConverter(t) {
        return new Tu(this.firestore, t, this.tf);
    }
}
 ...
 */ function mu(t, ...e) {
    for (const n of e) t = n.sf(t);
    return t;
}

class Au extends Iu {
    constructor(t, e, n) {
        super(), this.rf = t, this.cf = e, this.uf = n, this.type = "where";
    }
    sf(t) {
 ...
 */
        ...
        }(t.tf, "where", e, t.firestore.R_, this.rf, this.cf, this.uf);
        return new Tu(t.firestore, t.j_, function(t, e) {
 ...
 */ class Ru extends Iu {
    constructor(t, e) {
        super(), this.rf = t, this.af = e, this.type = "orderBy";
    }
    sf(t) {
 ...
 */ class Pu extends Iu {
    constructor(t, e, n) {
        super(), this.type = t, this.hf = e, this.lf = n;
    }
    sf(t) {
        return new Tu(t.firestore, t.j_, Qn(t.tf, this.hf, this.lf));
    }
}
 ...
 */ class gu extends Iu {
    constructor(t, e, n) {
        super(), this.type = t, this._f = e, this.ff = n;
    }
    sf(t) {
        const e = Vu(t, this.type, this._f, this.ff);
        return new Tu(t.firestore, t.j_, function(t, e) {
...
function Vu(t, e, n, s) {
    if (n[0] instanceof Ac && (n[0] = n[0].o_), n[0] instanceof jc) return function(t, e, n, s, i) {
 ...
 */ (t.tf, t.firestore.R_, e, n[0].W_, s);
    {
 ...
 */ (t.tf, t.firestore.R_, i, e, n, s);
    }
}

function pu(t, e, n) {
    if (n instanceof Ac && (n = n.o_), "string" == typeof n) {
    ...
    if (n instanceof Eu) return ne(t, n.K_);
    throw new N(C.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + pc(n) + ".");
}
 ...
 */ class Du extends Tu {
    constructor(t, e, n) {
        super(t, e, On(n)), this.firestore = t, this.nf = n, this.type = "collection";
    }
     ...
     */    withConverter(t) {
        return new Du(this.firestore, t, this.nf);
    }
}

function Cu(t, e, ...n) {
    if (Rc("collection", "path", e), t instanceof Bc) {
        const s = j.Y(e, ...n);
        return Vc(s), new Du(t, /* converter= */ null, s);
    }
    {
        ...
        return Vc(s), new Du(t.firestore, 
        /* converter= */ null, s);
    }
}
 ...
 * @return The created `Query`.
 */ function Nu(t, e) {
    if (Rc("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new N(C.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new Tu(t, 
...
function xu(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = L.D()), Rc("doc", "path", e), t instanceof Bc) {
        const s = j.Y(e, ...n);
        return yc(s), new Eu(t, 
        /* converter= */ null, new H(s));
    }
    {
        if (!(t instanceof Eu || t instanceof Du)) throw new N(C.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t.nf.child(j.Y(e, ...n));
        return yc(s), new Eu(t.firestore, t instanceof Du ? t.j_ : null, new H(s));
    }
}
 ...
 * Firestore database.
 */ function Ou(t, e) {
    return (t instanceof Eu || t instanceof Du) && (e instanceof Eu || e instanceof Du) && (t.firestore === e.firestore && t.path === e.path && t.j_ === e.j_);
}
 ...
 * Firestore database.
 */ function Mu(t, e) {
    return t instanceof Tu && e instanceof Tu && (t.firestore === e.firestore && Kn(t.tf, e.tf) && t.j_ === e.j_);
}

function ku(t) {
    const e = t.S_(), n = Is(t.R_);
    return new Qu(t.R_, !!e.ignoreUndefinedProperties, n);
}
...
/** A "context" object passed around while parsing user data. */ class Uu {
    ...
    constructor(t, e, n, s, i, r) {
        ...
        void 0 === i && this.df(), this.fieldTransforms = i || [], this.en = r || [];
    }
    get path() {
    ...
    /** Returns a new context with the specified settings overwritten. */    wf(t) {
    ...
    Ef(t) {
        var e;
        const n = null === (e = this.path) || void 0 === e ? void 0 : e.child(t), s = this.wf({
            path: n,
            __: !1
        });
        return s.Tf(t), s;
    ...
    h_(t) {
        return ea(t, this.settings.methodName, this.settings.Af || !1, this.path, this.settings.l_);
    }
    ...
    df() {
        ...
        // within arrays.
        if (this.path) for (let t = 0; t < this.path.length; t++) this.Tf(this.path.get(t));
    }
    Tf(t) {
        if (0 === t.length) throw this.h_("Document fields must not be empty");
        if (qu(this.a_) && $u.test(t)) throw this.h_('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class Qu {
    ...
    /** Creates a new top-level parse context. */    Rf(t, e, n, s = !1) {
        return new Uu({
            a_: t,
            methodName: e,
            l_: n,
...
/** Parse document data from a set() call. */ function Ku(t, e, n, s, i, r = {}) {
    const o = t.Rf(r.merge || r.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
...
/** Parse update data from a list of field/value arguments. */ function ju(t, e, n, s, i, r) {
    const o = t.Rf(1 /* Update */ , e, n), c = [ Xu(e, s, n) ], u = [ i ];
 ...
 */ function Gu(t, e, n, s = !1) {
    return zu(n, t.Rf(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function zu(t, e) {
    ...
    // from firestore-exp.
    t instanceof Ac && (t = t.o_), Ju(t)) return Yu("Unsupported field value:", e, t), 
    Hu(t, e);
    if (t instanceof Sc) 
 ...
 */
    return function(t, e) {
        ...
        if (!qu(e.a_)) throw e.h_(t.c_ + "() can only be used with update() and set()");
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        if (t instanceof kc) return {
            bytesValue: we(e.serializer, t.T_)
        };
        if (t instanceof Eu) {
            const n = e.t, s = t.firestore.R_;
            if (!s.isEqual(n)) throw e.h_(`Document reference is for database ${s.projectId}/${s.database} but should be for database ${n.projectId}/${n.database}`);
            return {
                referenceValue: Ie(t.firestore.R_ || e.t, t.K_.path)
            };
        }
        if (void 0 === t && e.ignoreUndefinedProperties) return null;
        throw e.h_("Unsupported field value: " + pc(t));
    }
    /**
...
function Ju(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof Q || t instanceof Mc || t instanceof kc || t instanceof Eu || t instanceof Sc);
}
...
function Yu(t, e, n) {
    if (!Ju(n) || !function(t) {
        ...
        const s = pc(n);
        throw "an object" === s ? e.h_(t + " a custom object") : e.h_(t + " " + s);
    }
}
 ...
 */ function Xu(t, e, n) {
    ...
    // FieldPath.
    e instanceof Ac && (e = e.o_), e instanceof Hc) return e.G_;
 ...
 */ class sa {
    ...
    async pf(t) {
        if (this.vf(), this.mutations.length > 0) throw new N(C.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
        const e = await async function(t, e) {
            const n = D(t), s = ye(n.serializer) + "/documents", i = {
                documents: e.map((t => Ae(n.serializer, t)))
            }, r = await n.Ru("BatchGetDocuments", s, i), o = new Map;
            r.forEach((t => {
        ...
        return e.forEach((t => {
            t instanceof Cn || t instanceof Dn ? this.bf(t) : b();
        })), e;
    }
    set(t, e) {
    ...
    delete(t) {
        this.write([ new yn(t, this.rn(t)) ]), this.Vf.add(t.toString());
    }
    async commit() {
        ...
        t.forEach(((t, e) => {
            ...
            await n.Au("Commit", s, i);
        }(this.Nu, this.mutations), this.gf = !0;
    }
    bf(t) {
        let e;
        ...
        const n = this.Pf.get(t.key.toString());
        if (n) {
            if (!e.isEqual(n)) 
     ...
     */    rn(t) {
        const e = this.Pf.get(t.toString());
        return !this.Vf.has(t.toString()) && e ? hn.updateTime(e) : hn.on();
    }
    /**
...
class ia {
    constructor(t, e, n, s) {
        this.di = t, this.Nu = e, this.updateFunction = n, this.Ti = s, this.Df = 5, this.Si = new Vs(this.di, "transaction_retry" /* TransactionRetry */);
    }
    ...
    Cf() {
        this.Si.Bs((async () => {
            const t = new sa(this.Nu), e = this.Nf(t);
            e && e.then((e => {
    ...
    xf(t) {
        this.Df > 0 && this.Ff(t) ? (this.Df -= 1, this.di.Ri((() => (this.Cf(), Promise.resolve())))) : this.Ti.reject(t);
    }
    Ff(t) {
...
class ra {
    ...
    Mf(t) {
        this.Of = t, 
        // eslint-disable-next-line @typescript-eslint/no-floating-promises
        this.g.promise.then((() => this.Of(this.user)));
    }
    /**
    ...
    terminate() {
        ...
        return this.di.Ni((async () => {
            try {
                this.$f && await this.$f.terminate(), this.Lf && await this.Lf.terminate(), 
...
async function oa(t, e) {
    ...
    await e.initialize(n), t.Mf((n => t.di.Mi((async () => {
        await or(e.Cu, n);
    })))), 
    // When a user calls clearPersistence() in one client, all other clients
    // need to be terminated to allow the delete to succeed.
    e.persistence.tc((() => t.terminate())), t.Lf = e;
}
...
async function ca(t, e) {
    ...
    t.Mf((n => t.di.Mi((() => async function(t, e) {
        const n = D(t);
        ...
        // new mutations from the LocalStore (since mutations are per-user).
                n.Mu.add(3 /* CredentialChange */), await Vr(n), s && 
        // Don't set the network status to Unknown if we are offline.
        n.Bu.set("Unknown" /* Unknown */), await n.xu.s_(e), n.Mu.delete(3 /* CredentialChange */), 
        await yr(n);
    }(e.Oh, n))))), t.$f = e;
}

async function ua(t) {
    return t.Lf || (y("FirestoreClient", "Using default OfflineComponentProvider"), 
    await oa(t, new wc)), t.Lf;
}

async function aa(t) {
    return t.$f || (y("FirestoreClient", "Using default OnlineComponentProvider"), await ca(t, new Ic)), 
    t.$f;
}
...
function la(t) {
    return ua(t).then((t => t.Cu));
}

function _a(t) {
    return aa(t).then((t => t.Oh));
}

function fa(t) {
    return aa(t).then((t => t.ga));
}

async function da(t) {
    const e = await aa(t), n = e.Mh;
    return n.Ju = yo.bind(null, e.ga), n.Zu = po.bind(null, e.ga), n;
}
...
function Ta(t, e, n, s, i) {
    const r = new mc({
        next: n => {
            // Remove query first before passing event to user to avoid
            // user actions affecting the now stale query.
            e.Ri((() => to(t, o))), n.fromCache && "server" === s.source ? i.reject(new N(C.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
        },
        error: t => i.reject(t)
    }), o = new io(n, r, {
        includeMetadataChanges: !0,
 ...
 */ class Ia {
    constructor(t, e) {
        this.U_ = t, this.Bf = e, this.qf = [], this.Uf = !1, this.Qf = ku(t);
    }
    set(t, e, n) {
        this.Kf();
        const s = ma(t, this.U_), i = La(s.j_, e, n), r = Ku(this.Qf, "WriteBatch.set", s.K_, i, null !== s.j_, n);
        return this.qf = this.qf.concat(r.ef(s.K_, hn.on())), this;
    }
    update(t, e, n, ...s) {
        this.Kf();
        const i = ma(t, this.U_);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                let r;
        return e instanceof Ac && (e = e.o_), r = "string" == typeof e || e instanceof Hc ? ju(this.Qf, "WriteBatch.update", i.K_, e, n, s) : Wu(this.Qf, "WriteBatch.update", i.K_, e), 
        this.qf = this.qf.concat(r.ef(i.K_, hn.exists(!0))), this;
    }
    /**
     ...
     */    delete(t) {
        this.Kf();
        const e = ma(t, this.U_);
        return this.qf = this.qf.concat(new yn(e.K_, hn.on())), this;
    }
    /**
    ...
    Kf() {
        if (this.Uf) throw new N(C.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }
}

function ma(t, e) {
    if (t instanceof Ac && (t = t.o_), t.firestore !== e) throw new N(C.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
...
class Aa extends class {
    constructor(t, e) {
        this.U_ = t, this.Wf = e, this.Qf = ku(t);
    }
    /**
     ...
     */    get(t) {
        const e = ma(t, this.U_), n = new Fu(this.U_);
        return this.Wf.pf([ e.K_ ]).then((t => {
            if (!t || 1 !== t.length) return b();
            const s = t[0];
            if (s instanceof Cn) return new jc(this.U_, n, e.K_, null, e.j_);
            if (s instanceof Dn) return new jc(this.U_, n, s.key, s, e.j_);
            throw b();
        }));
    }
    set(t, e, n) {
        const s = ma(t, this.U_), i = La(s.j_, e, n), r = Ku(this.Qf, "Transaction.set", s.K_, i, null !== s.j_, n);
        return this.Wf.set(s.K_, r), this;
    }
    update(t, e, n, ...s) {
        const i = ma(t, this.U_);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                let r;
        return e instanceof Ac && (e = e.o_), r = "string" == typeof e || e instanceof Hc ? ju(this.Qf, "Transaction.update", i.K_, e, n, s) : Wu(this.Qf, "Transaction.update", i.K_, e), 
        this.Wf.update(i.K_, r), this;
    }
    /**
     * Deletes the document referred to by the provided {@link DocumentReference}.
     *
     ...
     * @return A `DocumentSnapshot` with the read data.
     */    get(t) {
        const e = ma(t, this.U_), n = new uu(this.U_);
        return super.get(t).then((t => new su(this.U_, n, e.K_, t.W_, new Ca(
        /* hasPendingWrites= */ !1, 
        /* fromCache= */ !1), e.j_)));
    }
}
 ...
 */ class Pa extends Ac {
    constructor(t, e, n) {
        super(e), this.jf = n, this.INTERNAL = {
            delete: () => this.terminate()
        }, t instanceof A || (this.Gf = t);
    }
    get R_() {
        return this.o_.R_;
    }
    ...
    useEmulator(t, e) {
        "firestore.googleapis.com" !== this.o_.b_().host && p("Host has been set in both settings() and useEmulator(), emulator host will be used"), 
        this.settings({
            host: `${t}:${e}`,
            ssl: !1,
            merge: !0
    ...
    enablePersistence(t) {
        let e = !1, n = !1;
        return t && (e = !!t.synchronizeTabs, n = !!t.experimentalForceOwningTab, gc("synchronizeTabs", e, "experimentalForceOwningTab", n)), 
    ...
    get app() {
        if (!this.Gf) throw new N(C.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this.Gf;
    }
    collection(t) {
        try {
...
class Va extends Ac {
    ...
    get(t) {
        const e = $a(t);
        return this.o_.get(e).then((t => new Na(this.U_, t)));
    }
    set(t, e, n) {
        const s = $a(t);
        return n ? (Pc("Transaction.set", n), this.o_.set(s, e, n)) : this.o_.set(s, e), 
        this;
    }
    update(t, e, n, ...s) {
        const i = $a(t);
...
class pa extends Ac {
    set(t, e, n) {
        const s = $a(t);
        return n ? (Pc("WriteBatch.set", n), this.o_.set(s, e, n)) : this.o_.set(s, e), 
        this;
    }
    update(t, e, n, ...s) {
        const i = $a(t);
 ...
 */ class va extends Ac {
    constructor(t, e) {
        super(e), this.firestore = t, this.Q_ = new Wc(t);
    }
    static zf(t, e, n) {
    ...
    isEqual(t) {
        return t instanceof Ac && (t = t.o_), t instanceof Eu && Ou(this.o_, t);
    }
    set(t, e) {
        e = Pc("DocumentReference.set", e);
        try {
            return function(t, e, n) {
                const s = vc(t.firestore, Jc), i = La(t.j_, e, n);
                return du(s, Ku(ku(s), "setDoc", t.K_, i, null !== t.j_, n).ef(t.K_, hn.on()));
            }(this.o_, t, e);
        } catch (t) {
    ...
    delete() {
        return du(vc((t = this.o_).firestore, Jc), [ new yn(t.K_, hn.on()) ]);
        var t;
        /**
 ...
 */    }
    onSnapshot(...t) {
        const e = Sa(t), n = Da(t, (t => new Na(this.firestore, new su(this.firestore.o_, this.Q_, t.K_, t.W_, t.metadata, this.o_.j_))));
        return _u(this.o_, e, n);
    }
    get(t) {
        let e;
        return e = "cache" === (null == t ? void 0 : t.source) ? au(this.o_) : "server" === (null == t ? void 0 : t.source) ? function(t) {
            const e = vc(t.firestore, Jc), n = ga(e), s = new Ts;
            return e.z_.Ri((async () => {
                const i = await da(n);
                await Ea(i, e.z_, t.K_, {
                    source: "server"
                }, s);
            })), s.promise.then((n => wu(e, t, n)));
        }
        /**
 ...
 */ (this.o_) : function(t) {
        ...
        }(this.o_), e.then((t => new Na(this.firestore, new su(this.firestore.o_, this.Q_, t.K_, t.W_, t.metadata, this.o_.j_))));
    }
    withConverter(t) {
...
class Na extends Ac {
    ...
    get ref() {
        return new va(this.U_, this.o_.ref);
    }
    get id() {
        return this.o_.id;
    }
    ...
    limit(t) {
        try {
            return new Fa(this.firestore, mu(this.o_, function(t) {
                return bc("limit", t), new Pu("limit", t, "F" /* First */);
            }
            /**
 ...
 */ (t)));
    ...
    limitToLast(t) {
        try {
            return new Fa(this.firestore, mu(this.o_, function(t) {
                return bc("limitToLast", t), new Pu("limitToLast", t, "L" /* Last */);
            }(t)));
        } catch (t) {
    ...
    get(t) {
        ...
        return e = "cache" === (null == t ? void 0 : t.source) ? hu(this.o_) : "server" === (null == t ? void 0 : t.source) ? function(t) {
            ...
            return e.z_.Ri((async () => {
                const s = await da(n);
                await Ta(s, e.z_, t.tf, {
                    source: "server"
                }, i);
            })), i.promise.then((n => new ru(e, s, t, n)));
        }(this.o_) : function(t) {
            const e = vc(t.firestore, Jc), n = ga(e), s = new uu(e);
            Su(t.tf);
            const i = new Ts;
            return e.z_.Ri((async () => {
                const s = await da(n);
        ...
        }(this.o_), e.then((t => new Ma(this.firestore, t)));
    }
    onSnapshot(...t) {
        const e = Sa(t), n = Da(t, (t => new Ma(this.firestore, t)));
        return _u(this.o_, e, n);
    }
    withConverter(t) {
...
class Oa extends Ac {
    ...
    get doc() {
        return new xa(this.U_, this.o_.doc);
    }
    get oldIndex() {
...
class Ma extends Ac {
    ...
    get query() {
        return new Fa(this.U_, this.o_.query);
    }
    get metadata() {
        return this.o_.metadata;
    }
    ...
    get docs() {
        return this.o_.docs.map((t => new xa(this.U_, t)));
    }
    docChanges(t) {
        return this.o_.docChanges(t).map((t => new Oa(this.U_, t)));
    }
    forEach(t, e) {
        this.o_.forEach((n => {
            t.call(e, new xa(this.U_, n));
        }));
    }
    isEqual(t) {
        return cu(this.o_, t.o_);
...
class ka extends Fa {
    ...
    add(t) {
        return function(t, e) {
            const n = vc(t.firestore, Jc), s = xu(t), i = La(t.j_, e);
            return du(n, Ku(ku(t.firestore), "addDoc", s.K_, i, null !== t.j_, {}).ef(s.K_, hn.exists(!1))).then((() => s));
...
function $a(t) {
    return t instanceof Ac && (t = t.o_), vc(t, Eu);
}
 ...
 */ class Ba extends Ac {
    ...
    isEqual(t) {
        return t instanceof Ac && (t = t.o_), t instanceof Hc && this.o_.G_.isEqual(t.G_);
    }
}
...
class qa extends Ac {
    static serverTimestamp() {
        const t = new Nc("serverTimestamp");
        return t.c_ = "FieldValue.serverTimestamp", new qa(t);
    }
    static delete() {
        const t = new Dc("deleteField");
        return t.c_ = "FieldValue.delete", new qa(t);
    }
    static arrayUnion(...t) {
        const e = 
        /**
 ...
 * `updateDoc()`
 */ (...t);
        return e.c_ = "FieldValue.arrayUnion", new qa(e);
    }
    static arrayRemove(...t) {
        const e = function(...t) {
            // NOTE: We don't actually parse the data until it's used in set() or
            // update() since we'd need the Firestore instance to do this.
            return new Fc("arrayRemove", t);
        }
        /**
 * Returns a special value that can be used with {@link setDoc()} or {@link
 ...
 * `updateDoc()`
 */ (...t);
        return e.c_ = "FieldValue.arrayRemove", new qa(e);
    }
    static increment(t) {
        const e = function(t) {
            return new Oc("increment", t);
        }(t);
        return e.c_ = "FieldValue.increment", new qa(e);
    }
    isEqual(t) {
        return this.o_.isEqual(t.o_);
    }
...
function Qa(t) {
    ...
    }(t, ((t, e) => new Pa(t, new Jc(t, e), new Ra))), t.registerVersion("@firebase/firestore", "2.0.4");
}
