...
import { CollectionReference, DocumentReference, Query, SetOptions, UpdateData } from '../../../lite/src/api/reference';
...
export { DocumentReference, CollectionReference, Query, collection, collectionGroup, doc, query, where, limit, limitToLast, orderBy, startAt, startAfter, endAt, endBefore, queryEqual } from '../../../lite/src/api/reference';
/**
